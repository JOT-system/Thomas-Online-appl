<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COM00005SELECT.aspx.vb" Inherits="OFFICE.COM00005SELECT" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewOrgId = '<%= Me.vLeftOrg.ClientID %>';                      /* 組織コード */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtCompany.ClientID %>', viewCompanyId],
                                   ['<%= Me.txtOrg.ClientID %>', viewOrgId]];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbOrg.ClientID %>', '3', '1']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="COM00005S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr style="display:none">
		                <td colspan="2">
			                <a><asp:Label ID="lblCompany" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtCompany" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblOrg" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtOrg" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblOrgText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                </table>
