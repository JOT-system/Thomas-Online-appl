<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COM00005USER.aspx.vb" Inherits="OFFICE.COM00005USER" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
        #divDetailActionBox a:nth-child(3) {
            order: 5;
        }
        #lblUserID {
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ...
                                           ['<%= Me.lbRoleMap.ClientID %>', '3', '1'],
                                           ['<%= Me.lbRoleOrg.ClientID %>', '3', '1'],
                                           ['<%= Me.lbOrg.ClientID %>', '3', '1'],
                                           ['<%= Me.lbLoginFlg.ClientID %>', '3', '1']];
            ...
            <div id="divContensbox">
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            <asp:Label ID="lblOperationEx" runat="server" Text="操作" Font-Bold="True" Font-Underline="True"></asp:Label>
                            <asp:TextBox ID="txtOperationEx" runat="server" ></asp:TextBox>
                            <asp:Label ID="lblUserIdEx" runat="server" Text="ユーザＩＤ" ></asp:Label>
                            <asp:TextBox ID="txtUserIdEx" runat="server" ></asp:TextBox>
                            <asp:Label ID="lblStaffNameEx" runat="server" Text="社員名" ></asp:Label>
                            <asp:TextBox ID="txtStaffNameEx" runat="server" ></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div  id="detailStaticbox">
                        <div id="divDetailActionBox">
                            ...
                            <a><input type="button" id="btnInit" value="初期化" runat="server"/></a>
                            <%-- 選択No --%>
                            <a id="stLineCnt">
                        ...
                        <div class="detailInputRow">
                            <%-- ユーザーID --%>
                            <a id="stUserID">
                                <asp:Label ID="lblUserID" runat="server" Text="ユーザーID" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtUserID" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblUserIDText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <%-- 有効年月日 --%>
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabUser">
                            <asp:Label ID="lblDtabUser" runat="server" Text="ユーザー情報"></asp:Label>
                        </a>
                    </div>
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  　組織コード　 --%>
                    <asp:View id="vLeftOrg" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbOrg" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 組織コード VIEW　 --%>
                    <%--  　権限（機能）　 --%>
                    <asp:View id="vLeftRoleMap" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbRoleMap" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 権限（機能） VIEW　 --%>
                    <%--  　権限（組織）　 --%>
                    <asp:View id="vLeftRoleOrg" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbRoleOrg" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 権限（組織） VIEW　 --%>
                     <%--  　削除フラグ　 --%>
                    ...
                    <%--  　ログインチェックフラグ　 --%>
                    <asp:View id="vLeftLoginFlg" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbLoginFlg" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END ログインチェックフラグ VIEW　 --%>
                    <%--  　カレンダー　 --%>
