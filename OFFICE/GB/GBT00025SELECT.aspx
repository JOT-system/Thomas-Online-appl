<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00025SELECT.aspx.vb" Inherits="OFFICE.GBT00025SELECT" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewListId = '<%= Me.vLeftListId.ClientID %>';              /* 荷主コード */
            var dblClickObjects = [['<%= Me.txtList.ClientID %>', viewListId]];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbList.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [['<%= Me.txtList.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00025S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblList" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtList" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblListText" runat="server" ></asp:Label></a>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <%-- 動的条件フィールド --%>
                    <asp:Repeater ID="repListConditions" runat="server">
                        <ItemTemplate>
                            <tr class='<%# Container.DataItem.FieldSetting  %>'>
		                        <td colspan="2">
                                    <asp:HiddenField ID="hdnCOnditionKey" runat="server" Value='<%# Container.DataItem.[Key] %>' Visible="false"  />
                                    <asp:HiddenField ID="hdnFieldSetting" runat="server" Value='<%# Container.DataItem.[FieldSetting] %>' Visible="false"  />
			                        <asp:Label ID="lblCondition" runat="server" Text='<%# Container.DataItem.FieldName %>'></asp:Label>
		                        </td>
		                        <td>
			                        <asp:TextBox ID="txtCondition" runat="server" Text='<%# Container.DataItem.Value %>' Enabled='<%# If(Container.DataItem.FieldSetting = GBT00025SValues.FieldSettings.Fix, "False", "True")  %>'></asp:TextBox>
		                        </td>
                                <td colspan="2">
			                        <asp:Label ID="lblConditionText" runat="server" Text='<%# Container.DataItem.[Text] %>'></asp:Label>
		                        </td>
                                <td>
                                    &nbsp;
                                </td>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  　帳票リストID　 --%>
                    <asp:View id="vLeftListId" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbList" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 帳票リストID VIEW　 --%>
                    <%--  　カレンダー　 --%>
