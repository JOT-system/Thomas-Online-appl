<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00002SELECT.aspx.vb" Inherits="OFFICE.GBM00002SELECT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbOrgCode.ClientID %>', '3', '1']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00002S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgCode" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtOrgCode" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgCodeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
