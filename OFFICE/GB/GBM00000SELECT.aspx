<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00000SELECT.aspx.vb" Inherits="OFFICE.GBM00000SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewMASTERTYPEId = '<%= Me.vLeftMASTERTYPE.ClientID %>';                      /* マスタ種別 */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtMASTERTYPE.ClientID %>', viewMASTERTYPEId]
                                  ];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbMASTERTYPE.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [
                                         ['<%= Me.txtMASTERTYPE.ClientID %>']
                                        ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00000S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblMASTERTYPE" runat="server"  CssClass="requiredMark"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtMASTERTYPE" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblMASTERTYPEText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  マスタ種別 --%>
                    <asp:View id="vLeftMASTERTYPE" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbMASTERTYPE" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END マスタ種別 VIEW --%>
                    <%--  　カレンダー　 --%>
