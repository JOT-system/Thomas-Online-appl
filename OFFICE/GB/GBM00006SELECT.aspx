<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00006SELECT.aspx.vb" Inherits="OFFICE.GBM00006SELECT" %>
<!DOCTYPE html>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00006S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
