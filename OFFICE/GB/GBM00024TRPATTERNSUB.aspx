<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00024TRPATTERNSUB.aspx.vb" Inherits="OFFICE.GBM00024TRPATTERNSUB" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <link href="css/GBM00024TRPATTERNSUB.css" rel="stylesheet" type="text/css" />
    <style>
        .UnderLine {
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewTrPatternId = '<%= Me.vLeftTrPattern.ClientID %>'           /* 輸送パターン */
            ...
            ['<%= Me.txtTrPattern.ClientID %>', viewTrPatternId],
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ['<%= Me.lbTrPattern.ClientID %>', '3', '1'],
                                           ['<%= Me.lbAgent.ClientID %>', '3', '1'],
                                           ['<%= Me.lbBilling.ClientID %>', '3', '1'],
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        ...
                        <div id="divSearchConditionBox">
                            ...
                            <span>
                                <asp:Label ID="lblTrPatternEx" runat="server" Text=""></asp:Label>
                                <asp:TextBox ID="txtTrPatternEx" runat="server" Text="" TabIndex="1"></asp:TextBox>
                            </span>
                        </div>
                    </div>
                    <div id="divListArea">
                ...
                <div  class="detailbox" id="detailbox">
                    <div  id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            <%-- 輸送パターン --%>
                            <a id="stTrPattern">
                                <asp:Label ID="lblTrPattern" runat="server" Text="輸送パターン" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtTrPattern" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblTrPatternText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 削除フラグ --%>
                            <a id="stDelFlg">
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  　輸送パターン　 --%>
                    <asp:View id="vLeftTrPattern" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbTrPattern" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 輸送パターン VIEW　 --%>
                    <%--  　Agent　 --%>
                    <asp:View id="vLeftAgent" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbAgent" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END Agent VIEW　 --%>
                    <%--  　Billing　 --%>
                    <asp:View id="vLeftBilling" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbBilling" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END Billing VIEW　 --%>
                    <%--  　港　 --%>
