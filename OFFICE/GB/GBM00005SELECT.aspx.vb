...
''' 業者検索画面クラス
''' </summary>
Public Class GBM00005SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00005S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00005"
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00005TRADER Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00005TRADER Then
            Dim prevPage As GBM00005TRADER = DirectCast(Page.PreviousPage, GBM00005TRADER)
            '実行画面からの画面遷移
            '○画面項目設定処理
    ...
    Public Sub checkProc()
        ...
        '分類
        COA0008InvalidChar.CHARin = txtClass.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtClass.Text = COA0008InvalidChar.CHARout
        End If
        ...
        '分類
        CheckSingle("CLASS", txtClass.Text)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtClass.Focus()
            Return
        End If
        ...
        End If
        '分類
        CheckList(txtClass.Text, lbClass)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtClass.Focus()
            Return
        End If
