...
''' タンク検索画面クラス
''' </summary>
Public Class GBM00006SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00006S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00006"
                ...
                Case Me.vLeftTankNo.ID 'アクティブなビューがタンク番号
                    ...
                    If targetObject IsNot Nothing Then
                        ...
                        If Me.lbTankNo.SelectedItem IsNot Nothing Then
                            ...
                            'Me.lblTankNoText.Text = Me.lbTankNo.SelectedItem.Text
                            txtobj.Focus()
                        Else
                            txtobj.Text = ""
                            'Me.lblTankNoText.Text = ""
                            txtobj.Focus()
                        End If
                    End If
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00006TANK Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00006TANK Then
            Dim prevPage As GBM00006TANK = DirectCast(Page.PreviousPage, GBM00006TANK)
            '実行画面からの画面遷移
            '○画面項目設定処理
            ...
            Dim dicObjs As New Dictionary(Of String, TextBox) From {{"hdnSelectedStYMD", Me.txtStYMD},
                                                                    ...
                                                                    {"hdnSelectedTankNo", Me.txtTankNo}
                                                                    }
    ...
    '        SetTankNoListItem(Me.txtTankNo.Text)
    '        If returnCode = C_MESSAGENO.NORMAL AndAlso Me.lbTankNo.Items.Count > 0 Then
    '            Dim findListItem = Me.lbTankNo.Items.FindByValue(Me.txtTankNo.Text)
    '            If findListItem IsNot Nothing Then
    '                Me.lblTankNoText.Text = findListItem.Text
    '            Else
    '                Dim findListItemUpper = Me.lbTankNo.Items.FindByValue(Me.txtTankNo.Text.ToUpper)
    '                If findListItemUpper IsNot Nothing Then
    '                    Me.lblTankNoText.Text = findListItemUpper.Text
    '                    Me.txtTankNo.Text = findListItemUpper.Value
    '                End If
    '            End If
    '        End If
