...
Partial Public Class GBT00011SELECT
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents GBT00011S As Global.System.Web.UI.HtmlControls.HtmlForm
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents txtDepot As Global.System.Web.UI.WebControls.TextBox
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lblDepotText As Global.System.Web.UI.WebControls.Label
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents vLeftTank As Global.System.Web.UI.WebControls.View
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lbTank As Global.System.Web.UI.WebControls.ListBox
