<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00030DETAILEDLIST.aspx.vb" Inherits="OFFICE.GBT00030DETAILEDLIST" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00030DETAILEDLIST.css" rel="stylesheet" type="text/css" />
    <style>
    </style>
    <%--共通利用するJavaScript --%>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00030D" runat="server" >
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
