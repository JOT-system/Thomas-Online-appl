<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00012SELECT.aspx.vb" Inherits="OFFICE.GBT00012SELECT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewTankNo = '<%= Me.vLeftTank.ClientID %>';   
            var viewLastCargo = '<%= Me.vLeftLastCargo.ClientID %>';
            ...
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ...
                                   ['<%= Me.txtLastCargo.ClientID %>', viewLastCargo],
                                   ['<%= Me.txtLocation.ClientID %>', viewLocation]
                                  ];
            ...
            var leftListExtentionTarget = [['<%= Me.lbTank.ClientID %>', '3', '1'],
                                           ['<%= Me.lbLastCargo.ClientID %>', '3', '1'],
                                           ['<%= Me.lbLocation.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);
            
            ///* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [['<%= Me.txtTankNo.ClientID %>'],['<%= Me.txtLastCargo.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00012S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblLastCargo" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtLastCargo" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblLastCargoText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                    <%-- Location --%>
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblLocation" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtLocation" runat="server"></asp:TextBox></a>
		                </td>
	                </tr>
                </table>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  　Last Cargo　 --%>
                    <asp:View id="vLeftLastCargo" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbLastCargo" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
                    </asp:View> <%-- END Last Cargo VIEW　 --%>
                    <%--  　Location　 --%>
                    <asp:View id="vLeftLocation" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbLocation" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
