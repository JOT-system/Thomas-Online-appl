...
Partial Public Class GBT00010SELECT
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents GBT00010S As Global.System.Web.UI.HtmlControls.HtmlForm
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lblCostType As Global.System.Web.UI.WebControls.Label
    ...
    '''<summary>
    '''lblCostTypeText コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lblCostTypeText As Global.System.Web.UI.WebControls.Label
