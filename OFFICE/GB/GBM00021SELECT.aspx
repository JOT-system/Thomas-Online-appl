<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00021SELECT.aspx.vb" Inherits="OFFICE.GBM00021SELECT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbToriKbn.ClientID %>', '3', '1'],
                                           ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00021S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                <td>
			                <a><asp:Label ID="lblYMD1" runat="server" CssToriCode="requiredMark"></asp:Label></a>
		                </td>
		                <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblToriKbn" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtToriKbn" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblToriKbnText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                    <%-- 取引先コード --%>
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblToriCode" runat="server" ></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtToriCode" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblToriCodeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <asp:View id="vLeftToriKbn" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbToriKbn" runat="server" CssToriCode="leftViewContents"></asp:ListBox>
                        </div>
