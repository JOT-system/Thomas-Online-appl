<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00022SELECT.aspx.vb" Inherits="OFFICE.GBM00022SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewOrgCountryId = '<%= Me.vLeftOrgCountry.ClientID %>';                /* 組織コード(国) */
            var viewOrgOfficeId = '<%= Me.vLeftOrgOffice.ClientID %>';                  /* 組織コード(オフィス) */
            var viewOrgPortId = '<%= Me.vLeftOrgPort.ClientID %>';                      /* 組織コード(港) */
            var viewOrgDepotId = '<%= Me.vLeftOrgDepot.ClientID %>';                    /* 組織コード(デポ) */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtOrgCountry.ClientID %>', viewOrgCountryId],
                                   ['<%= Me.txtOrgOffice.ClientID %>', viewOrgOfficeId],
                                   ['<%= Me.txtOrgPort.ClientID %>', viewOrgPortId],
                                   ['<%= Me.txtOrgDepot.ClientID %>', viewOrgDepotId]
                                  ];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbOrgCountry.ClientID %>', '3', '1'],
                                            ['<%= Me.lbOrgOffice.ClientID %>', '3', '1'],
                                            ['<%= Me.lbOrgPort.ClientID %>', '3', '1'],
                                            ['<%= Me.lbOrgDepot.ClientID %>', '3', '1'],
                                        ];
            addLeftBoxExtention(leftListExtentionTarget);
            
            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [
                                         ['<%= Me.txtOrgCountry.ClientID %>'],
                                         ['<%= Me.txtOrgOffice.ClientID %>'],
                                         ['<%= Me.txtOrgPort.ClientID %>'],
                                         ['<%= Me.txtOrgDepot.ClientID %>']
                                        ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00022S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                <td>
			                <a><asp:Label ID="lblYMD1" runat="server" CssLevel1="requiredMark"></asp:Label></a>
		                </td>
		                <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgCountry" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtOrgCountry" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgCountryText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                    <%-- 組織コード(オフィス) --%>
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgOffice" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtOrgOffice" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgOfficeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                    <%-- 組織コード(港) --%>
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgPort" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtOrgPort" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgPortText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                    <%-- 組織コード(デポ) --%>
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgDepot" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtOrgDepot" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblOrgDepotText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  組織コード(国) --%>
                    <asp:View id="vLeftOrgCountry" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbOrgCountry" runat="server" CssLevel1="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 組織コード(国) VIEW --%>
                    <%--  組織コード(オフィス) --%>
                    <asp:View id="vLeftOrgOffice" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbOrgOffice" runat="server" CssLevel1="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 組織コード(港) VIEW --%>
                    <%--  組織コード(港) --%>
                    <asp:View id="vLeftOrgPort" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbOrgPort" runat="server" CssLevel1="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 組織コード(港) VIEW --%>
                    <%--  組織コード(デポ) --%>
                    <asp:View id="vLeftOrgDepot" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbOrgDepot" runat="server" CssLevel1="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 組織コード(デポ) VIEW --%>
                    <%--  　カレンダー　 --%>
