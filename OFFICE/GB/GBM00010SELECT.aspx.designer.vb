...
Partial Public Class GBM00010SELECT
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents GBM00010S As Global.System.Web.UI.HtmlControls.HtmlForm
    ...
    '''<summary>
    '''vLeftCostCode コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents vLeftCostCode As Global.System.Web.UI.WebControls.View
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lbCostCode As Global.System.Web.UI.WebControls.ListBox
