<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00003SELECT.aspx.vb" Inherits="OFFICE.GBT00003SELECT" %>
...
<head runat="server">
    ...
    <style>
       ...
       #itemTable tr:nth-child(3) td:nth-child(2),
       #itemTable tr:nth-child(3) td:nth-child(4)
       {
           text-align:right;
       }
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var dblClickObjects = [['<%= Me.txtETDStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtETDEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtETAStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtETAEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtShipper.ClientID %>', viewShipperId],
                                   ['<%= Me.txtConsignee.ClientID %>', viewConsigneeId],
                                   ['<%= Me.txtPortOfLoading.ClientID %>', viewPortId],
                                   ['<%= Me.txtPortOfDischarge.ClientID %>', viewPortId],
            ...
            var targetOnchangeObjects = [['<%= Me.txtShipper.ClientID %>'],
                                         ...
                                         ['<%= Me.txtPortOfLoading.ClientID %>'],
                                         ['<%= Me.txtPortOfDischarge.ClientID %>'],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00003S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtETDStYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblETDTilde" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtETDEndYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
	                ...
	                <tr>
		                <td>
			                <asp:Label ID="lblETA1" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:Label ID="lblETA2" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtETAStYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblETATilde" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtETAEndYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtShipper" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td colspan="2">
                    ...
                    <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtConsignee" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td colspan="2">
                    ...
                    <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtPortOfLoading" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td colspan="2">
			                <asp:Label ID="lblPortOfLoadingText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtPortOfDischarge" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td colspan="2">
			                <asp:Label ID="lblPortOfDischargeText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                ...
                <div id="divHidden">
                    ...
                    <%-- MapVariant保持 --%>
                    <asp:HiddenField ID="hdnThisMapVariant" runat="server" Value="" />
                </div>
            </div>
            <%-- 左ボックス --%>
            <div id="divLeftbox">
