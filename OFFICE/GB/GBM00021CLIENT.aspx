<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00021CLIENT.aspx.vb" Inherits="OFFICE.GBM00021CLIENT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewToriKbnId = '<%= Me.vLeftToriKbn.ClientID %>';              /* 取引先区分 */
            ...
            ['<%= Me.txtToriKbn.ClientID %>', viewToriKbnId],
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblNamesEx" runat="server" Text="名称(短)"></asp:Label>
                ...
                <div  class="detailbox" id="detailbox">
                    <div  id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            <%-- 取引先区分 --%>
                            <a id="stToriKbn">
                                <asp:Label ID="lblToriKbn" runat="server" Text="取引先区分" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtToriKbn" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblToriKbnText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <%-- 取引先コード --%>
                            <a id="stToriCode">
                                <asp:Label ID="lblToriCode" runat="server" Text="分類" CssClass="textLeft UnderLine" ></asp:Label>
                                <asp:TextBox ID="txtToriCode" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblToriCodeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
                ...
                <div id="divHidden">
                    ...
                    <%-- 前画面選択条件 --%>
                    <asp:HiddenField ID="hdnSelectedToriKbn" runat="server" Value="" />
                    <asp:HiddenField ID="hdnSelectedStYMD" runat="server" Value="" />
                    <asp:HiddenField ID="hdnSelectedEndYMD" runat="server" Value="" />
                    <asp:HiddenField ID="hdnSelectedToriCode" runat="server" Value="" />
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  取引先区分 --%>
                    <asp:View id="vLeftToriKbn" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbToriKbn" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 取引先区分 VIEW --%>
                    <%--  取引先コード --%>
