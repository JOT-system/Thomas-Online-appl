<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00018SELECT.aspx.vb" Inherits="OFFICE.GBT00018SELECT" %>
...
<%--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162522994-1"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewBillingDate = '<%= Me.vLeftBillingDate.ClientID %>';
            var dblClickObjects = [['<%= Me.txtBillingYmd.ClientID %>', viewBillingDate]];
            ...
            var targetOnchangeObjects = ['<%= Me.txtBillingYmd.ClientID %>'];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00018S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblBillingYmd" runat="server" CssClass="requiredMark"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtBillingYmd" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="3">
		                </td>
	                </tr>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  　請求月　 --%>
                    <asp:View id="vLeftBillingDate" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbBillingDate" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
                    </asp:View> <%-- END 請求月 VIEW　 --%>
                    <%--  　カレンダー　 --%>
