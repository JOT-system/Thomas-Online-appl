<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00013RESULT.aspx.vb" Inherits="OFFICE.GBT00013RESULT" %>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00013RESULT.css" rel="stylesheet" />
    <style>
        #divBreakerInfo {
            height:100%;
            width:100%;
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <%--個別のスクリプトは以下に記載 --%>
    <script type="text/javascript" src='<%= ResolveUrl("~/GB/script/GBT00013RESULT.js") %>'  charset="utf-8"></script>
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var targetButtonObjects = ['<%= Me.btnBack.ClientId  %>', '<%= Me.btnLeftBoxButtonSel.ClientId  %>',
                                       ...
                                       '<%= Me.btnLeftBoxButtonCan.ClientId  %>','<%= Me.btnSave.ClientID %>'];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00013R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <div id="divHidden">
                    ...
                    <asp:HiddenField ID="hdnListScrollXPos" Value="" runat="server" /> <%-- 横スクロール位置保持 --%>
                    
                    <asp:HiddenField ID="hasModifiedRow" runat="server" Value="" Visible="False" />
                    ...
                    <asp:HiddenField ID="hdnTextDistribution" runat="server" Value="" Visible="False" />
                    <asp:HiddenField ID="hdnTextEdit" runat="server" Value="" Visible="False" />
                    <asp:HiddenField ID="hdnTextIssue" runat="server" Value="" Visible="False" />
                    <asp:HiddenField ID="hdnTextUpdated" runat="server" Value="" Visible="False" />
                    ...
                    <%-- 次画面(B/L編集画面)引継用 --%>
                    <asp:HiddenField ID="hdnSelectedOrderNo" runat="server" Value="" Visible="False" />
                    <asp:HiddenField ID="hdnSelectedWhichTrans" runat="server" Value="" Visible="False" />
                    <%-- 削除確認メッセージ --%>                    
                    <asp:HiddenField ID="hdnConfirmTitle"  runat="server" Value="0" />
