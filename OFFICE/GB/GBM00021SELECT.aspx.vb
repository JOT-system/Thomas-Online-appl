...
''' 取引先検索画面クラス
''' </summary>
Public Class GBM00021SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00021S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00021"
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00021CLIENT Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00021CLIENT Then
            Dim prevPage As GBM00021CLIENT = DirectCast(Page.PreviousPage, GBM00021CLIENT)
            '実行画面からの画面遷移
            '○画面項目設定処理
            ...
            Dim dicObjs As New Dictionary(Of String, TextBox) From {{"hdnSelectedStYMD", Me.txtStYMD},
                                                                    ...
                                                                    {"hdnSelectedToriKbn", Me.txtToriKbn},
                                                                    {"hdnSelectedClass", Me.txtToriCode}
                                                                    }
    ...
    Public Sub checkProc()
        ...
        '取引先区分
        COA0008InvalidChar.CHARin = txtToriKbn.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtToriKbn.Text = COA0008InvalidChar.CHARout
        End If

        '取引先コード
        COA0008InvalidChar.CHARin = txtToriCode.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtToriCode.Text = COA0008InvalidChar.CHARout
        End If
        ...
        '取引先区分
        CheckSingle("TORIKBN", txtToriKbn.Text)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtToriKbn.Focus()
            Return
        End If
        ...
        '取引先コード
        CheckSingle("TORICODE", txtToriCode.Text)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtToriCode.Focus()
            Return
        End If
        ...
        '②存在チェック(LeftBoxチェック)
        '取引先区分
        CheckList(txtToriKbn.Text, lbToriKbn)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtToriKbn.Focus()
            Return
        End If
            ...
            If returnCode = C_MESSAGENO.NORMAL AndAlso Me.lbToriKbn.Items.Count > 0 Then
                ...
                If findListItem IsNot Nothing Then
                    ...
                    If findListItem.Text.Contains(":") Then
                        ...
                        Me.lblToriKbnText.Text = parts(1)
                    Else
