...
Public Class GLM00001TEST
    Inherits System.Web.UI.Page

    Const CONST_MAPID = "GLM00001"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim GLM00001TEST As New GLDLL.GLM00001TEST
        ...
        '■■■ 画面モード（更新・参照）設定  ■■■
        '
        If HttpContext.Current.Session("MAPpermitcode") = "2" Then
