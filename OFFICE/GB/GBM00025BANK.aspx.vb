...
''' 銀行マスタ画面クラス
''' </summary>
Public Class GBM00025BANK
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00025"    '自身のMAPID
    Private Const CONST_BASEDATATABLE = "GBM00025TBL"
    Private Const CONST_INPDATATABLE = "GBM00025INPTBL"
    Private Const CONST_UPDDATATABLE = "GBM00025UPDTBL"
    Private Const CONST_DSPROWCOUNT = 44                '指定数＋１が表示対象
    Private Const CONST_SCROLLROWCOUNT = 8              'マウススクロール時の増分
    Private Const CONST_TBLMASTER = "GBM0024_BANK"
    Private Const CONST_TBLAPPLY = "GBM0030_BANKAPPLY"
    Private Const CONST_EVENTCODE = "MasterApplyBank"
    ...
    Protected Sub GetListData()
        ...
        Try
            ...
            SQLStr =
                ...
                & "       isnull(rtrim(JOTBANKCODE),'')              as JOTBANKCODE , " _
                ...
                & "       isnull(rtrim(SWIFTCODE),'')                as SWIFTCODE , " _
                & "       isnull(rtrim(NAME),'')                     as NAME , " _
                & "       isnull(rtrim(NAMEJP),'')                   as NAMEJP , " _
                & "       isnull(rtrim(NAMEK),'')                    as NAMEK , " _
                & "       isnull(rtrim(BRANCHCODE),'')               as BRANCHCODE , " _
                & "       isnull(rtrim(BRANCHNAME),'')               as BRANCHNAME , " _
                & "       isnull(rtrim(BRANCHNAMEJP),'')             as BRANCHNAMEJP , " _
                & "       isnull(rtrim(BRANCHNAMEK),'')              as BRANCHNAMEK , " _
                & "       isnull(rtrim(ZIPCODE),'')                  as ZIPCODE , " _
                & "       isnull(rtrim(ADDR),'')                     as ADDR , " _
                & "       isnull(rtrim(ADDRJP),'')                   as ADDRJP , " _
                & "       isnull(rtrim(TEL),'')                      as TEL , " _
                & "       isnull(rtrim(TYPEOFACCOUNT),'')            as TYPEOFACCOUNT , " _
                & "       isnull(rtrim(ACCOUNTNO),'')                as ACCOUNTNO , " _
                & "       isnull(rtrim(ACCOUNTHOLDER),'')            as ACCOUNTHOLDER , " _
                & "       isnull(rtrim(ACCOUNTHOLDERK),'')           as ACCOUNTHOLDERK , " _
            ...
            Else
                SQLStr &= " SELECT * FROM " & CONST_TBLAPPLY & " as tbl2 " _
                    ...
                    & " AND   tbl1.JOTBANKCODE = tbl2.JOTBANKCODE " _
            ...
            Else
                'JOT銀行コード
                If (String.IsNullOrEmpty(Me.hdnSelectedJotBankCode.Value) = False) Then
                    SQLStr &= String.Format(" AND JOTBANKCODE like '{0}%' ", Me.hdnSelectedJotBankCode.Value)
                End If
    ...
    Protected Sub UploadExcel()
        ...
        For i As Integer = 0 To COA0029XlsTable.TBLDATA.Rows.Count - 1
            ...
            Dim JotBankCode As String = COA0029XlsTable.TBLDATA.Rows(i)("JOTBANKCODE").ToString
            If COA0029XlsTable.TBLDATA.Columns.Contains("STYMD") Then
                Dim stYmd As String = COA0029XlsTable.TBLDATA.Rows(i)("STYMD").ToString
                sameDr = (From item In BASEtbl Where item("JOTBANKCODE").Equals(JotBankCode) AndAlso item("STYMD").Equals(stYmd))
            Else
                sameDr = (From item In BASEtbl Where item("JOTBANKCODE").Equals(JotBankCode))
            End If
                ...
                If Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = updateDisp OrElse Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = deleteDisp Then
                    ...
                    Try
                        ...
                        With SQLcmd.Parameters
                            ...
                            .Add("@P02", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("JOTBANKCODE")
                            ...
                            Else
                                For j As Integer = 0 To BASEtbl.Rows.Count - 1
                                    ...
                                    If Convert.ToString(BASEtbl.Rows(j)("COMPCODE")) = Convert.ToString(BASEtbl.Rows(i)("COMPCODE")) AndAlso
                                       Convert.ToString(BASEtbl.Rows(j)("JOTBANKCODE")) = Convert.ToString(BASEtbl.Rows(i)("JOTBANKCODE")) AndAlso
                ...
                Try
                    ...
                    If Not (Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = errDisp OrElse Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = "★" & errDisp OrElse Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = "") Then
                        ...
                        With SQLcmd.Parameters
                            ...
                            .Add("@P03", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("JOTBANKCODE")
                            ...
                            .Add("@P06", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("BANKCODE")
                            .Add("@P07", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("SWIFTCODE")
                            .Add("@P08", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("NAME")
                            .Add("@P09", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("NAMEJP")
                            .Add("@P10", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("NAMEK")
                            .Add("@P11", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("BRANCHCODE")
                            .Add("@P12", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("BRANCHNAME")
                            .Add("@P13", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("BRANCHNAMEJP")
                            .Add("@P14", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("BRANCHNAMEK")
                            .Add("@P15", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ZIPCODE")
                            .Add("@P16", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ADDR")
                            .Add("@P17", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ADDRJP")
                            .Add("@P18", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("TEL")
                            .Add("@P19", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("TYPEOFACCOUNT")
                            .Add("@P20", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ACCOUNTNO")
                            .Add("@P21", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ACCOUNTHOLDER")
                            .Add("@P22", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("ACCOUNTHOLDERK")
                            .Add("@P23", System.Data.SqlDbType.NVarChar).Value = BASEtbl.Rows(i)("CURRENCYCODE")
    ...
    Protected Sub INPtblCheck()
        ...
        '事前準備（キー重複レコード削除）
        Dim dupCheckFields = CommonFunctions.CreateCompareFieldList({"COMPCODE", "JOTBANKCODE", "STYMD"})
        ...
        For i As Integer = 0 To INPtbl.Rows.Count - 1
            ...
            Else
                ...
                Dim compareFieldList = CommonFunctions.CreateCompareFieldList({"COMPCODE", "JOTBANKCODE"})
    ...
    Private Function ErrItemSet(ByVal argRow As DataRow) As String
        ...
        If (COA0019Session.LANGDISP <> C_LANG.JA) Then
            rtc &= ControlChars.NewLine & "  --> JOT BANK CODE   =" & Convert.ToString(argRow("JOTBANKCODE")) & " , "
        ...
        Else
            rtc &= ControlChars.NewLine & "  --> JOT銀行コード      =" & Convert.ToString(argRow("JOTBANKCODE")) & " , "
    ...
    Private Sub LangSetting(ByVal lang As String)
        ...
        '****************************************
        If (COA0019Session.LANGDISP <> C_LANG.JA) Then
            Me.lblDtabTrader.Text = "Bank Info"
        Else
            Me.lblDtabTrader.Text = "銀行口座情報"
        End If
    ...
    Protected Sub BASEtblColumnsAdd(table As DataTable)
        ...
        table.Columns.Add("JOTBANKCODE", GetType(String))
        table.Columns("JOTBANKCODE").DefaultValue = ""
        ...
        table.Columns.Add("SWIFTCODE", GetType(String))
        table.Columns("SWIFTCODE").DefaultValue = ""
        table.Columns.Add("NAME", GetType(String))
        table.Columns("NAME").DefaultValue = ""
        table.Columns.Add("NAMEJP", GetType(String))
        table.Columns("NAMEJP").DefaultValue = ""
        table.Columns.Add("NAMEK", GetType(String))
        table.Columns("NAMEK").DefaultValue = ""
        table.Columns.Add("BRANCHCODE", GetType(String))
        table.Columns("BRANCHCODE").DefaultValue = ""
        table.Columns.Add("BRANCHNAME", GetType(String))
        table.Columns("BRANCHNAME").DefaultValue = ""
        table.Columns.Add("BRANCHNAMEJP", GetType(String))
        table.Columns("BRANCHNAMEJP").DefaultValue = ""
        table.Columns.Add("BRANCHNAMEK", GetType(String))
        table.Columns("BRANCHNAMEK").DefaultValue = ""
        table.Columns.Add("ZIPCODE", GetType(String))
        table.Columns("ZIPCODE").DefaultValue = ""
        ...
        table.Columns.Add("TYPEOFACCOUNT", GetType(String))
        table.Columns("TYPEOFACCOUNT").DefaultValue = ""
        table.Columns.Add("ACCOUNTNO", GetType(String))
        table.Columns("ACCOUNTNO").DefaultValue = ""
        table.Columns.Add("ACCOUNTHOLDER", GetType(String))
        table.Columns("ACCOUNTHOLDER").DefaultValue = ""
        table.Columns.Add("ACCOUNTHOLDERK", GetType(String))
        table.Columns("ACCOUNTHOLDERK").DefaultValue = ""
    ...
    Protected Sub DefaultToTBL(argTbl As DataTable)
        ...
        workRow("BRANCHCODE") = ""
        workRow("BRANCHNAME") = ""
        workRow("BRANCHNAMEJP") = ""
        workRow("BRANCHNAMEK") = ""
        workRow("ZIPCODE") = ""
        workRow("ADDR") = ""
        workRow("ADDRJP") = ""
        workRow("TEL") = ""
        workRow("TYPEOFACCOUNT") = ""
        workRow("ACCOUNTNO") = ""
        workRow("ACCOUNTHOLDER") = ""
        workRow("ACCOUNTHOLDERK") = ""
    ...
    Protected Sub DetailBoxToINPtbl()
        ...
        For i As Integer = 0 To WW_DetailMAX - 1
            ...
            workRow("COMPCODE") = HttpContext.Current.Session("APSRVCamp")
            workRow("JOTBANKCODE") = txtJotBankCode.Text
    ...
    Protected Sub BASEtblUpdate()
        ...
        For i As Integer = 0 To BASEtbl.Rows.Count - 1
            ...
            End Select
        Next
        Dim compareUpdTargetFieldList = CommonFunctions.CreateCompareFieldList({"COMPCODE", "JOTBANKCODE", "STYMD"})
        Dim compareModCheckFieldList = CommonFunctions.CreateCompareFieldList({"ENDYMD", "BANKCODE", "SWIFTCODE",
                                                                               "NAME", "NAMEJP", "NAMEK",
                                                                               "BRANCHCODE", "BRANCHNAME", "BRANCHNAMEJP", "BRANCHNAMEK",
                                                                               "ZIPCODE", "ADDR", "ADDRJP", "TEL",
                                                                               "TYPEOFACCOUNT", "ACCOUNTNO", "ACCOUNTHOLDER", "ACCOUNTHOLDERK",
                                                                               "CURRENCYCODE",
                                                                               "REMARK", "DELFLG"})
            ...
            If Convert.ToString(drInput("HIDDEN")) <> "1" Then ' "1" ・・・取り込み対象外エラー
                ...
                If workBasePos >= 0 Then
                    ...
                    If Convert.ToString(workBaseRow("OPERATION")) <> errDisp OrElse
                        ...
                        workBaseRow("JOTBANKCODE") = drInput("JOTBANKCODE")
                        ...
                        workBaseRow("SWIFTCODE") = drInput("SWIFTCODE")
                        workBaseRow("NAME") = drInput("NAME")
                        workBaseRow("NAMEJP") = drInput("NAMEJP")
                        workBaseRow("NAMEK") = drInput("NAMEK")
                        workBaseRow("BRANCHCODE") = drInput("BRANCHCODE")
                        workBaseRow("BRANCHNAME") = drInput("BRANCHNAME")
                        workBaseRow("BRANCHNAMEJP") = drInput("BRANCHNAMEJP")
                        workBaseRow("BRANCHNAMEK") = drInput("BRANCHNAMEK")
                        workBaseRow("ZIPCODE") = drInput("ZIPCODE")
                        workBaseRow("ADDR") = drInput("ADDR")
                        workBaseRow("ADDRJP") = drInput("ADDRJP")
                        workBaseRow("TEL") = drInput("TEL")
                        workBaseRow("TYPEOFACCOUNT") = drInput("TYPEOFACCOUNT")
                        workBaseRow("ACCOUNTNO") = drInput("ACCOUNTNO")
                        workBaseRow("ACCOUNTHOLDER") = drInput("ACCOUNTHOLDER")
                        workBaseRow("ACCOUNTHOLDERK") = drInput("ACCOUNTHOLDERK")
    ...
    Protected Sub List_DBclick()
        ...
        txtCompCode_Change()
        txtJotBankCode.Text = Convert.ToString(dataTable(0)("JOTBANKCODE"))
    ...
    Private Sub SetPrevDisplayValues()
        If TypeOf Page.PreviousPage Is GBM00025SELECT Then
            '検索画面の場合
            Dim prevObj As GBM00025SELECT = DirectCast(Page.PreviousPage, GBM00025SELECT)
            ...
            Me.hdnSelectedJotBankCode.Value = DirectCast(prevObj.FindControl("txtJotBankCode"), TextBox).Text
