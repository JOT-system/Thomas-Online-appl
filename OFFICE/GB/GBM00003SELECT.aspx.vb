...
''' デポ検索画面クラス
''' </summary>
Public Class GBM00003SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00003S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00003"
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00003DEPOT Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00003DEPOT Then
            Dim prevPage As GBM00003DEPOT = DirectCast(Page.PreviousPage, GBM00003DEPOT)
            '実行画面からの画面遷移
            '○画面項目設定処理
