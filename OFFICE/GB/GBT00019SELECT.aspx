<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00019SELECT.aspx.vb" Inherits="OFFICE.GBT00019SELECT" %>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewOrderId = '<%= Me.vLeftOrderNo.ClientID %>';
            ...
            <%--var targetOnchangeObjects = [['<%= Me.txt.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00019S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
