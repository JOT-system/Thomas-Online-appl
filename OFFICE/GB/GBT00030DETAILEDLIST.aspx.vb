...
''' タンクステータス一覧画面クラス
''' </summary>
Public Class GBT00030DETAILEDLIST
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBT00030D" '自身のMAPID
    ...
    ''' </summary>
    ''' <returns></returns>
    Public Property OrderInfo As GBT00030DETAILEDLIST.GBT00030DOrderInfo
    ''' <summary>
    ''' 引当したリースタンク
    ''' </summary>
    ''' <returns></returns>
    ...
    Private Function GetListData() As DataTable
        ...
        If Me.hdnThisMapVariant.Value = "GB_TankSelect" Then
            ...
            Dim orderInfo As GBT00030DOrderInfo = DirectCast(ViewState("ORDERINFO"), GBT00030DOrderInfo)
        ...
        End If
        Dim dicTankInfo As GBT00030DOrderInfo = Nothing

        If ViewState("ORDERINFO") IsNot Nothing Then
            dicTankInfo = DirectCast(ViewState("ORDERINFO"), GBT00030DOrderInfo)
            '引当済のタンク番号一覧を取得
    ...
    Public Sub btnShowTankMaster_Click()
        Dim thisDisplayItems As GBT00030DITEMS = GetGbt00006items()
    ...
    Public Sub btnConfirmOk_Click()
        ...
        '引当済情報の取得
        Dim tankInfoList As Dictionary(Of String, GBT00030DTankInfo) = DirectCast(ViewState("UPDTANKINFO"), Dictionary(Of String, GBT00030DTankInfo))
    ...
    ''' <returns></returns>
    Private Function EntryApply(ByRef applyTankInfo As List(Of GBT00030DTankInfo)) As String
...
#End Region
    ...
    Public Function GetGbt00006items() As GBT00030DITEMS
        ...
        End If
        item.Gbt00006ROrderInfo = DirectCast(ViewState("ORDERINFO"), GBT00030DOrderInfo)
    ...
    Public Class GBT00030DITEMS
        ...
        Public Property Gbt00006ROrderInfo As GBT00030DOrderInfo
    ...
    ''' </summary>
    <Serializable>
    Public Class GBT00030DOrderInfo
        ''' <summary>
        ''' オーダーNo
        ''' </summary>
        ''' <returns></returns>
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Property TankInfoList As Dictionary(Of String, GBT00030DTankInfo)
        ''' <summary>
        ''' リースタンク利用
        ''' </summary>
        ''' <returns></returns>
    ...
    ''' </summary>
    <Serializable>
    Public Class GBT00030DTankInfo
        ''' <summary>
        ''' TANKSEQ
        ''' </summary>
        ''' <returns></returns>
