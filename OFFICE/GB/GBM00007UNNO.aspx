<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00007UNNO.aspx.vb" Inherits="OFFICE.GBM00007UNNO" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
        ...
        #lblHazardClassEx,#lblPackingGroupEx {
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewUnNoId = '<%= Me.vLeftUnNo.ClientID %>';                    /* 国連番号 */
            var viewHazardClassId = '<%= Me.vLeftHazardClass.ClientID %>';      /* 等級 */
            var viewPackingGroupId = '<%= Me.vLeftPackingGroup.ClientID %>';    /* 容器等級 */
            var viewEnabledId = '<%= Me.vLeftEnabled.ClientID %>';                /* 削除フラグ */
            ...
            ['<%= Me.txtHazardClass.ClientID %>', viewHazardClassId],
            ['<%= Me.txtPackingGroup.ClientID %>', viewPackingGroupId],
            ['<%= Me.txtEnabled.ClientID %>', viewEnabledId],
            ['<%= Me.txtDelFlg.ClientID %>', viewDelFlgId],
            ['<%= Me.txtHazardClassEx.ClientID %>', viewHazardClassId],
            ['<%= Me.txtPackingGroupEx.ClientID %>', viewPackingGroupId]];
            ...
            var targetOnchangeObjects = [['<%= Me.txtPackingGroupEx.ClientID %>'],
            <%--['<%= Me.txtUnNo.ClientID %>'],--%>
            ['<%= Me.txtHazardClass.ClientID %>'],
            ['<%= Me.txtPackingGroup.ClientID %>'],
            ['<%= Me.txtEnabled.ClientID %>'],
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblUnNoEx" runat="server" Text="国連番号"></asp:Label>
                            <asp:TextBox ID="txtUnNoEx" runat="server"></asp:TextBox>
                            <asp:Label ID="lblHazardClassEx" runat="server"></asp:Label>
                            <asp:TextBox ID="txtHazardClassEx" runat="server"></asp:TextBox>
                            <asp:Label ID="lblPackingGroupEx" runat="server" Text="容器等級"></asp:Label>
                            <asp:TextBox ID="txtPackingGroupEx" runat="server"></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            <%-- 国連番号 --%>
                            <a id="stUnNo">
                                <asp:Label ID="lblUnNo" runat="server" Text="国連番号" CssClass="textLeft requiredMark"></asp:Label>
                        ...
                        <div class="detailInputRow">
                            <%-- 等級 --%>
                            <a id="stHazardClass">
                                <asp:Label ID="lblHazardClass" runat="server" Text="等級" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtHazardClass" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblHazardClassText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 容器等級 --%>
                            <a id="stPackingGroup">
                                <asp:Label ID="lblPackingGroup" runat="server" Text="容器等級" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtPackingGroup" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblPackingGroupText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <%-- 有効年月日 --%>
                            ...
                            <%-- Enabled --%>
                            <a id="stEnabled">
                                <asp:Label ID="lblEnabled" runat="server" Text="有効" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtEnabled" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblEnabledText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <a class="dummy"></a>
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabUnNo" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabUnNo" runat="server" Text="国連番号情報" Height="1.3em" Width="7em" Font-Size="Medium" ></asp:Label>
                        </a>
<%--                        <a id="stDtabDocument" onclick="DtabChange('1')">
                            <asp:Label ID="lblDtabDocument" runat="server" Text="書類（PDF）" Height="1.3em" Width="9em" Font-Size="Medium"></asp:Label>
                        </a>--%>
                    </div>
                            ...
                            <span class="WF_DViewRep1_Area" id="WF_DViewRep1_Area">
                               <asp:Repeater ID="WF_DViewRep1" runat="server"  >
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td>
                                            <%-- 値（名称）　左Side --%>
                                            <asp:Label ID="WF_Rep1_VALUE_TEXT_1" runat="server" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- スペース --%>
                                        ...
                                        <td>
                                            <%-- 値（名称）　中央 --%>
                                            <asp:Label ID="WF_Rep1_VALUE_TEXT_2" runat="server" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- スペース --%>
                                        ...
                                        <td>
                                            <%-- 値（名称）　右Side --%>
                                            <asp:Label ID="WF_Rep1_VALUE_TEXT_3" runat="server" CssClass="textLeft"></asp:Label>
                                        </td>
                                        </tr>
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
                ...
                <div id="divHidden">
                    ...
                    <asp:HiddenField id="hdnPrevCondStYMD" runat="server" Value="" />
                    <asp:HiddenField id="hdnPrevCondEndYMD" runat="server" Value="" />
                    <asp:HiddenField id="hdnPrevCondUNNO" runat="server" Value="" />
                    <asp:HiddenField id="hdnPrevCondHazardClass" runat="server" Value="" />
                    <asp:HiddenField id="hdnPrevCondPackingGroup" runat="server" Value="" />
                    <asp:HiddenField id="hdnSelectedApplyID" runat="server" Value="" />
                    <%-- Operation表示文字列 --%>
                    <asp:HiddenField id="hdnOpeStrUpdate" runat="server" Value="" />
                    <asp:HiddenField id="hdnOpeStrError" runat="server" Value="" />
