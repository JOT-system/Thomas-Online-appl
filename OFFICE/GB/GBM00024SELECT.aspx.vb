...
''' 輸送パターンサブ検索画面クラス
''' </summary>
Public Class GBM00024SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00024S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00024"
                ...
                Case Me.vLeftTransportPattern.ID 'アクティブなビューが輸送パターン
                    ...
                    If targetObject IsNot Nothing Then
                        ...
                        If Me.lbTransportpattern.SelectedItem IsNot Nothing Then
                            ...
                            Me.lblTransportpatternText.Text = Me.lbTransportpattern.SelectedItem.Text
                            txtobj.Focus()
                        Else
                            txtobj.Text = ""
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00024TRPATTERNSUB Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00024TRPATTERNSUB Then
            Dim prevPage As GBM00024TRPATTERNSUB = DirectCast(Page.PreviousPage, GBM00024TRPATTERNSUB)
            '実行画面からの画面遷移
            '○画面項目設定処理
    ...
    Public Sub checkProc()
        ...
        '輸送パターン
        COA0008InvalidChar.CHARin = txtTransportpattern.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtTransportpattern.Text = COA0008InvalidChar.CHARout
        End If
        ...
        '輸送パターン
        CheckSingle("USETYPE", txtTransportPattern.Text)
        If returnCode <> C_MESSAGENO.NORMAL Then
        ...
        Try
            ...
            If returnCode = C_MESSAGENO.NORMAL AndAlso Me.lbTransportpattern.Items.Count > 0 Then
                ...
                If findListItem IsNot Nothing Then
                    ...
                    Else
                        Me.lblTransportpatternText.Text = findListItem.Text
                    End If
                Else
                    ...
                    If findListItemUpper IsNot Nothing Then
                        ...
                        Else
                            Me.lblTransportpatternText.Text = findListItemUpper.Text
                            Me.txtTransportpattern.Text = findListItemUpper.Value
                        End If
