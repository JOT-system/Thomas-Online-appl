<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00008SELECT.aspx.vb" Inherits="OFFICE.GBM00008SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewUNNOId = '<%= Me.vLeftUNNO.ClientID %>';                    /* 国連番号コード */
            var viewEnabled = '<%= Me.vLeftEnabled.ClientID %>';                    /* 有効フラグ */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ...
                                   ['<%= Me.txtEnabled.ClientID %>', viewEnabled]];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00008S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblEnabled" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtEnabled" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblEnabledText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                </table>
