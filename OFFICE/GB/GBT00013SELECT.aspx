<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00013SELECT.aspx.vb" Inherits="OFFICE.GBT00013SELECT" %>
...
<head runat="server">
    ...
    <style>
       ...
       #itemTable tr:nth-child(10) td:nth-child(1){
	   ...
	   /* From To文言のセル設定 */
       #itemTable tr:nth-child(4) td:nth-child(2),
       #itemTable tr:nth-child(4) td:nth-child(4)
       {
           text-align:right;
       }
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewPortId = '<%= Me.vLeftPort.ClientID %>';                    /* 港コード */
            var viewProductId = '<%= Me.vLeftProduct.ClientId %>';              /* 積載品コード */
            var viewCarrierId = '<%= Me.vLeftCarrier.ClientId %>';
            var viewOfficeId = '<%= Me.vLeftOffice.ClientID %>';                /* 代理店コード */
            var viewBlIssued = '<%= Me.vLeftBlIssued.ClientID %>';
            var viewCountryId = '<%= Me.vLeftCountry.ClientID %>';              /* 国コード */
            var dblClickObjects = [['<%= Me.txtBlIssued.ClientID %>', viewBlIssued],
                                   ['<%= Me.txtETDStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtETDEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtShipper.ClientID %>', viewShipperId],
                                   ['<%= Me.txtConsignee.ClientID %>', viewConsigneeId],
                                   ['<%= Me.txtPort.ClientID %>', viewPortId],
                                   ['<%= Me.txtProduct.ClientID %>', viewProductId],
                                   ['<%= Me.txtCarrier.ClientID %>', viewCarrierId],
            ...
            var leftListExtentionTarget = [['<%= Me.lbShipper.ClientID %>', '3', '1'],
                                           ...
                                           ['<%= Me.lbDepartureArrival.ClientID %>', '3', '1'],
                                           ['<%= Me.lbCountry.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);
            
            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [['<%= Me.txtBlIssued.ClientID %>'],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00013S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <asp:Label ID="lblDepartureArrival" runat="server" ></asp:Label>
		                </td>
		                <%--<td>
			                <asp:TextBox ID="txtDepartureArrival" runat="server" ></asp:TextBox>
		                </td>
                        <td colspan="2">
			                <asp:Label ID="lblDepartureArrivalText" runat="server" ></asp:Label>
		                </td>--%>
                        <td colspan="3">
                            <asp:RadioButtonList ID="rblDepartureArrival" runat="server" RepeatLayout="UnorderedList">
	                ...
	                <tr>
		                <td colspan="2">
			                <asp:Label ID="lblBlIssued" runat="server" ></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtBlIssued" runat="server" ></asp:TextBox>
		                </td>
                        <td colspan="2">
                             <asp:Label ID="lblBlIssuedText" runat="server"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                        </td>
	                ...
	                <tr>
		                <td>
			                <asp:Label ID="lblETD1" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:Label ID="lblETD2" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtETDStYMD" runat="server" ></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblETDTilde" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtETDEndYMD" runat="server" ></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
			                <asp:Label ID="lblShipperText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
			                <asp:Label ID="lblConsigneeText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
			                <asp:Label ID="lblPortText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblCarrier" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtCarrier" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblCarrierText" runat="server" ></asp:Label></a>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblVsl" runat="server"></asp:Label></a>
		                </td>
		                <td colspan="3">
			                <a><asp:TextBox ID="txtVsl" runat="server"></asp:TextBox></a>
		                </td>
                        <td>
                            &nbsp;
                        </td>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  　荷主コード　 --%>
                    <asp:View id="vLeftBlIssued" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbBlIssued" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    ...
                    <asp:View id="vLeftPort" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbPort" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
                    </asp:View> <%-- END 港コード VIEW　 --%>
                    <%-- 積載品 VIEW　 --%>
                    ...
                    <%--  　発着区分　 --%>
                    <asp:View id="vLeftDepartureArrival" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbDepartureArrival" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
                    </asp:View> <%-- END 発着区分 VIEW　 --%>
                    <%--  　国コード　 --%>
