<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00010SELECT.aspx.vb" Inherits="OFFICE.GBM00010SELECT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewCostCodeId = '<%= Me.vLeftCostCode.ClientID %>';            /* 費用コード */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtCostCode.ClientID %>', viewCostCodeId]
                                  ];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbCostCode.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [
                                         ['<%= Me.txtCostCode.ClientID %>']
                                        ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00010S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblCostCode" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtCostCode" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblCostCodeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
