<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00016FORMOUTPUT.aspx.vb" Inherits="OFFICE.GBT00016FORMOUTPUT" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var targetOnchangeObjects = [['<%= Me.txtDepartment.ClientID %>']];
        ...
        <div id="divContainer">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td >
                            <a><asp:Label ID="lblOrderNo" runat="server" CssClass="requiredMark" Text="Order No."></asp:Label></a>
                        </td>
                        <td>
			                <a><asp:TextBox ID="txtOrderNo" runat="server"></asp:TextBox></a>
		                </td>
                    </tr>
                    <tr>
                        <td>
                            <a><asp:Label ID="lblTransClass" runat="server" Text="Tran Class"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtTransClass" runat="server"></asp:TextBox></a>
                        </td>
                        <td>
                            <a><asp:Label ID="lblTransClassText" runat="server" ></asp:Label></a>
                        </td>                    
                    </tr>
                    <tr>
                        <td>
                            <a><asp:Label ID="lblDepartment" runat="server" Text="Department"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtDepartment" runat="server"></asp:TextBox></a>
                        </td>
                        <td>
                            <a><asp:Label ID="lblDepartmentText" runat="server" ></asp:Label></a>
                        </td>                    
                    </tr>
                </table>
