...
''' 国検索画面クラス
''' </summary>
Public Class GBM00001SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00001S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00001"
    ...
    Private Sub LangSetting(ByVal lang As String)
        ...
        AddLangSetting(dicDisplayText, Me.lblOrgCode, "組織コード", "Org Code")
    ...
    Public Sub DefaultValueSet()
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00001COUNTRY Then
            Dim prevPage As GBM00001COUNTRY = DirectCast(Page.PreviousPage, GBM00001COUNTRY)
            '実行画面からの画面遷移
            '○画面項目設定処理
            ...
            Dim dicObjs As New Dictionary(Of String, TextBox) From {{"hdnSelectedStYMD", Me.txtStYMD},
                                                                    ...
                                                                    {"hdnSelectedOrgCode", Me.txtOrgCode}
                                                                    }
    ...
    Public Sub checkProc()
        ...
        '組織コード
        COA0008InvalidChar.CHARin = txtOrgCode.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtOrgCode.Text = COA0008InvalidChar.CHARout
        End If
        ...
        '組織コード
        CheckSingle("ORGCODE", txtOrgCode.Text)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtOrgCode.Focus()
            Return
        End If
        ...
        '②存在チェック(LeftBoxチェック)
        '組織コード
        CheckList(txtOrgCode.Text, lbOrgCode)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtOrgCode.Focus()
            Return
        End If
