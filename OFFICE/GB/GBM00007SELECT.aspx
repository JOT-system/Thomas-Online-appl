<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00007SELECT.aspx.vb" Inherits="OFFICE.GBM00007SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
       ...
       /*#itemTable tr:nth-child(2) td:nth-child(3){
           overflow:hidden;
           color: black ;
           font-size: small;
           vertical-align:middle;
       ...
       #itemTable tr:nth-child(3) td:nth-child(3){
           overflow:hidden;
           color: black ;
           font-size: small;
           vertical-align:middle;
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ...
                                   ['<%= Me.txtUnNo.ClientID %>', viewUnNoId],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00007S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblUnNo" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtUnNo" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblUnNoText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                    <%-- 等級 --%> 
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblHazardClass" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtHazardClass" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblHazardClassText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                    <%-- 容器等級 --%> 
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblPackingGroup" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtPackingGroup" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblPackingGroupText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                </table>
