<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00021RESULT.aspx.vb" Inherits="OFFICE.GBT00021RESULT" %>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00021RESULT.css" rel="stylesheet" />
    <style>
    </style>
    ...
    <%--個別のスクリプトは以下に記載 --%>
    <script type="text/javascript" src='<%= ResolveUrl("~/GB/script/GBT00021RESULT.js") %>'  charset="utf-8"></script>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00021R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <div id="divHidden">
                    ...
                    <%-- 前画面(検索条件)引継用 --%>
                    <asp:HiddenField ID="hdnStActualDate" runat="server" Value="" Visible="False" />
                    <asp:HiddenField ID="hdnEndActualDate" runat="server" Value="" Visible="False" />
                    ...
                    <asp:HiddenField ID="hdnSearchDataType" runat="server" Value="" Visible="False" />
                    <%-- 次画面引継用 --%>
