<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00010SELECT.aspx.vb" Inherits="OFFICE.GBT00010SELECT" %>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ...
                                   ['<%= Me.txtCostType.ClientID %>', viewCostTypeId]];
            ...
            var targetOnchangeObjects = [['<%= Me.txtCostType.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00010S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblCostType" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtCostType" runat="server"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblCostTypeText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                </table>
