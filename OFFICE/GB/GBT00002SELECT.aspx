<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00002SELECT.aspx.vb" Inherits="OFFICE.GBT00002SELECT" %>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00002S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblOffice" runat="server" CssClass="requiredMark"></asp:Label></a>
		                </td>
		                <td>
