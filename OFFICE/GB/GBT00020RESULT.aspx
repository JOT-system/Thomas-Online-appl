<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00020RESULT.aspx.vb" Inherits="OFFICE.GBT00020RESULT" %>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00020RESULT.css" rel="stylesheet" />
    <style>
    </style>
    <%--共通利用するJavaScript --%>
    ...
    <%--個別のスクリプトは以下に記載 --%>
    <script type="text/javascript" src='<%= ResolveUrl("~/GB/script/GBT00020RESULT.js") %>'  charset="utf-8"></script>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00020R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <div id="actionButtonsBox">
                    ...
                    <input id="btnLeaseNew" type="button" value="新規作成"  runat="server"  />
                    <input id="btnApply" type="button" value="申請"  runat="server" visible="false"  />
