<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00014SELECT.aspx.vb" Inherits="OFFICE.GBM00014SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var targetButtonObjects = ['<%= Me.btnEnter.ClientId  %>',
                                       '<%= Me.btnBack.ClientId  %>', 
            ...
            var viewCompanyId = '<%= Me.vLeftCompany.ClientID %>';              /* 会社コード */
            var viewAgentId = '<%= Me.vLeftAgent.ClientID %>';                  /* 代理店コード */
            var dblClickObjects = [['<%= Me.txtCompany.ClientID %>', viewCompanyId],
                                   ['<%= Me.txtAgent.ClientID %>', viewAgentId]];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbCompany.ClientID %>', '3', '1'],
                                           ['<%= Me.lbAgent.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);
            
            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [['<%= Me.txtCompany.ClientID %>'],
                                         ['<%= Me.txtAgent.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00014S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                <div id="actionButtonsBox">
                    <input id="btnEnter" type="button" value="実行" tabindex="2"  runat="server"/>
                    <input id="btnBack" type="button" value="終了"  tabindex="2"  runat="server" />
                    <div id="btnFIRST" class="firstPage" style="visibility: hidden;"></div>
                    <div id="btnLAST" class="lastPage" style="visibility: hidden;"></div>
                </div>
                ...
                <table id="itemTable">
                    ...
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblCompany" runat="server"  CssClass="requiredMark"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtCompany" runat="server" TabIndex="1"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblCompanyText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                    <%-- 代理店コード --%> 
                    <tr>
		                <td colspan="2">
			                <a><asp:Label ID="lblAgent" runat="server"  CssClass="requiredMark"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtAgent" runat="server" TabIndex="1"></asp:TextBox></a>
		                </td>
                        <td colspan="2">
			                <a><asp:Label ID="lblAgentText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                </table>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  　会社コード　 --%>
                    <asp:View id="vLeftCompany" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCompany" runat="server" CssClass="leftViewContents"></asp:ListBox>                           
                        </div>
