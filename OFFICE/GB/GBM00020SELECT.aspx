<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00020SELECT.aspx.vb" Inherits="OFFICE.GBM00020SELECT" %>
<!DOCTYPE html>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00020S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                ...
		                <td>
			                <a><asp:TextBox ID="txtStYMD" runat="server" MaxLength="7"></asp:TextBox></a>
		                </td>
		                <td>
			                <a><asp:Label ID="lblTilde" runat="server"></asp:Label></a>
		                </td>
		                <td>
			                <a><asp:TextBox ID="txtEndYMD" runat="server" MaxLength="7"></asp:TextBox></a>
		                </td>
	                </tr>
                    <%-- 国コード --%>
                    <tr>
