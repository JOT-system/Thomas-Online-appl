<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00021SELECT.aspx.vb" Inherits="OFFICE.GBT00021SELECT" %>
...
<head runat="server">
    ...
    <style>
       ...
       #itemTable tr:nth-child(1) td:nth-child(4)
       {
           text-align:right;
       }
...
<%--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162522994-1"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var targetButtonObjects = ['<%= Me.btnEnter.ClientId  %>', '<%= Me.btnBack.ClientId  %>',
            ...
            var viewTankNo = '<%= Me.vLeftTankNo.ClientID %>';              /* タンク番号 */
            var dblClickObjects = [['<%= Me.txtStActualDate.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndActualDate.ClientID %>', viewCalId],
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbActy.ClientID %>', '3', '1'],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00021S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                ...
		                <td>
			                <asp:Label ID="lblActualDate2" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtStActualDate" runat="server" tabindex="1"></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblTilde" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtEndActualDate" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
		                ...
		                <td>
			                <asp:TextBox ID="txtCountry" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td colspan="2">
			                <asp:Label ID="lblCountryText" runat="server" ></asp:Label>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblDataType" runat="server" Text="データ区分"></asp:Label>
                        </td>
                        <td colspan="4">
                            <asp:RadioButtonList ID="rblDataType" runat="server" RepeatLayout="UnorderedList">
                                <asp:ListItem Text="THOMAS" Value="THOMAS"></asp:ListItem>
                                <asp:ListItem Text="TACOS data before 201812" Value="TACOS"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
