...
''' Repair履歴検索画面クラス
''' </summary>
Public Class GBT00022SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBT00022S"     '自身のMAPID
    Private Const CONST_BASEID As String = "GBT00022R"
    ...
    Public Sub btnEnter_Click()
        ...
        '日付設定
        If Me.txtStApproveDate.Text <> "" AndAlso Me.txtEndApproveDate.Text = "" Then
            Me.txtEndApproveDate.Text = Me.txtStApproveDate.Text
        End If

        If Me.txtEndApproveDate.Text <> "" AndAlso Me.txtStApproveDate.Text = "" Then
            Me.txtStApproveDate.Text = Me.txtEndApproveDate.Text
        End If
    ...
    Private Sub LangSetting(ByVal lang As String)
        ...
        AddLangSetting(dicDisplayText, Me.lblApproveDate, "実施日", "Approve Date")
        AddLangSetting(dicDisplayText, Me.lblApproveDate2, "範囲指定", "From")
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBT00022RESULT Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBT00022RESULT Then
            ...
            Dim dicObjs As New Dictionary(Of String, TextBox) From {{"hdnStApproveDate", Me.txtStApproveDate},
                                                                    {"hdnEndApproveDate", Me.txtEndApproveDate},
    ...
    Public Sub variableSet()
        ...
        Dim dicDefaultValueSettings As New Dictionary(Of String, TextBox) _
                        From {{"APPROVEDATEST", Me.txtStApproveDate},
                              {"APPROVEDATEEND", Me.txtEndApproveDate},
                              {"TANKNO", Me.txtTankNo},
    ...
    Public Sub checkProc()
        ...
        '開始日
        COA0008InvalidChar.CHARin = txtStApproveDate.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtStApproveDate.Text = COA0008InvalidChar.CHARout
        End If

        '終了日
        COA0008InvalidChar.CHARin = txtEndApproveDate.Text
        COA0008InvalidChar.COA0008RemoveInvalidChar()
        If COA0008InvalidChar.CHARin = COA0008InvalidChar.CHARout Then
        Else
            txtEndApproveDate.Text = COA0008InvalidChar.CHARout
        End If
        ...
        '開始日 単項目チェック
        Dim stStr As String = FormatDateYMD(txtStApproveDate.Text, GBA00003UserSetting.DATEFORMAT)
        CheckSingle("APPROVEDATEST", stStr)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtStApproveDate.Focus()
            Return
        End If
        ...
        '終了日 単項目チェック
        Dim endStr As String = FormatDateYMD(txtEndApproveDate.Text, GBA00003UserSetting.DATEFORMAT)
        CheckSingle("APPROVEDATEEND", endStr)
        If returnCode <> C_MESSAGENO.NORMAL Then
            txtEndApproveDate.Focus()
            Return
        End If
