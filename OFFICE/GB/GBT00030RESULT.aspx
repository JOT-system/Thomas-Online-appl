<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00030RESULT.aspx.vb" Inherits="OFFICE.GBT00030RESULT" %>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00030RESULT.css" rel="stylesheet" />
    <style>
    </style>
    <%--共通利用するJavaScript --%>
    ...
    <%--個別のスクリプトは以下に記載 --%>
    <script type="text/javascript" src='<%= ResolveUrl("~/GB/script/GBT00030RESULT.js") %>'  charset="utf-8"></script>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00030R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
