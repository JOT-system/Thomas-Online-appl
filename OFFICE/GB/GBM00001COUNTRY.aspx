<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00001COUNTRY.aspx.vb" Inherits="OFFICE.GBM00001COUNTRY" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var targetOnchangeObjects = [['<%= Me.txtCompCode.ClientID %>'],
            ...
            <div id="divContensbox">
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblNamesEx" runat="server" Text="国名称" Font-Bold="True"></asp:Label>
                ...
                <div  class="detailbox" id="detailbox">
                    <div  id="detailStaticbox">
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabCountry" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabCountry" runat="server" Text="国情報"></asp:Label>
                        </a>
                    </div>
