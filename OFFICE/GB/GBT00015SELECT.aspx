<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00015SELECT.aspx.vb" Inherits="OFFICE.GBT00015SELECT" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbOffice.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [['<%= Me.txtOffice.ClientID %>']];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00015S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
