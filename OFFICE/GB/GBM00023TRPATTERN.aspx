<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00023TRPATTERN.aspx.vb" Inherits="OFFICE.GBM00023TRPATTERN" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <link href="css/GBM00023TRPATTERN.css" rel="stylesheet" type="text/css" />
    <style>
        .UnderLine {
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ['<%= Me.lbAgentKbn.ClientID %>', '3', '1'],
                                           ['<%= Me.lbCostCode.ClientID %>', '3', '1'],
                                           ['<%= Me.lbTermType.ClientID %>', '3', '1'],
                                           ['<%= Me.lbActionId.ClientID %>', '3', '1'],
                                           ['<%= Me.lbTankFilling.ClientID %>', '3', '1'],
                                           ['<%= Me.lbScheduleDay.ClientID %>', '3', '1'],
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        ...
                        <div id="divSearchConditionBox">
                            ...
                            <span>
                                <asp:Label ID="lblUseTypeEx" runat="server" Text=""></asp:Label>
                                <asp:TextBox ID="txtUseTypeEx" runat="server" Text="" TabIndex="1"></asp:TextBox>
                            </span>
                        </div>
                    </div>
                    <div id="divListArea">
                ...
                <div  class="detailbox" id="detailbox">
                    <div  id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            <%-- ブレーカー種類 --%>
                            <a id="stBrType">
                                <asp:Label ID="lblBrType" runat="server" Text="ブレーカー種類" CssClass="textLeft UnderLine requiredMark"></asp:Label>
                                <asp:TextBox ID="txtBrType" runat="server" CssClass="aspNetDisabled"></asp:TextBox>
                                <asp:Label ID="lblBrTypeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 輸送パターン --%>
                            <a id="stUseType">
                                <asp:Label ID="lblUseType" runat="server" Text="輸送パターン" CssClass="textLeft UnderLine requiredMark"></asp:Label>
                                <asp:TextBox ID="txtUseType" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblUseTypeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <%-- データID --%>
                            <a id="stDataId">
                                <asp:Label ID="lblDataId" runat="server" Text="データID" CssClass="textLeft UnderLine" ></asp:Label>
                                <asp:TextBox ID="txtDataId" runat="server" CssClass="aspNetDisabled"></asp:TextBox>
                                <asp:Label ID="lblDataIdText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 削除フラグ --%>
                            <a id="stDelFlg">
                        ...
                        <a id="stDtabTrader" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabTransportPattern" runat="server" Text="輸送パターン情報" ></asp:Label>
                        </a>
                    </div>
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
                ...
                <div id="divHidden">
                    ...
                    <asp:HiddenField ID="hdnSelectedBreakerType" runat="server" Value="" />
                    <asp:HiddenField ID="hdnSelectedBreakerTypeValue" runat="server" Value="" />
                    <asp:HiddenField ID="hdnSelectedTransportPattern" runat="server" Value="" />
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  　担当区分　 --%>
                    <asp:View id="vLeftAgentKbn" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbAgentKbn" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 担当区分 VIEW　 --%>
                    <%--  　費用コード　 --%>
                    <asp:View id="vLeftCostCode" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCostCode" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 費用コード VIEW　 --%>
                    <%--  　輸送形態タイプ　 --%>
                    <asp:View id="vLeftTermType" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbTermType" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 輸送形態タイプ VIEW　 --%>
                    <%--  　アクションコード　 --%>
                    <asp:View id="vLeftActionId" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbActionId" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END アクションコード VIEW　 --%>
                    <%--  　タンク充填状態　 --%>
                    <asp:View id="vLeftTankFilling" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbTankFilling" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END タンク充填状態 VIEW　 --%>
                    <%--  　予定日付参照　 --%>
                    <asp:View id="vLeftScheduleDay" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbScheduleDay" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 予定日付参照 VIEW　 --%>
                    <%--  削除フラグ --%>
