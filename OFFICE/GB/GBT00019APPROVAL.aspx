<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00019APPROVAL.aspx.vb" Inherits="OFFICE.GBT00019APPROVAL" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00019APPROVAL.css" rel="stylesheet" />
    <style>
        #divApprovalInfo {
            height:100%;
            width:100%;
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewTankNo = '<%= Me.vLeftTankNo.ClientID %>';                  /* 費用種別 */
            ...
            /* タンクマスタ画面の表示 */
            var masterOpenFlg = document.getElementById('hdnTankViewOpen');
        ...
        function openMasterWindow() {
            ...
            var mstUrl = document.getElementById('hdnTankViewUrl').value; // ポストするURL
            var mstApplyID = document.getElementById('hdnSelectTankNo').value; // ポストする申請ID
            ...
            var qs = [{ type: 'hidden', name: 'hdnSender', value: '<%= Me.Form.ID %>' },
                      { type: 'hidden', name: 'hdnSelectTankNo', value: mstApplyID }];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00019A" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <div id="divSearchConditionBox">
                    ...
                    <span>
                        <asp:Label ID="lblApplicantIdLabel" runat="server" Text=""></asp:Label>
                        <asp:TextBox ID="txtApplicantId" runat="server" Text="" TabIndex="1"></asp:TextBox>
                    </span>
                </div>
                ...
                <div id="divHidden">
                    ...
                    <asp:HiddenField ID="hdnSelectTankNo" runat="server" Value="" />
                    <asp:HiddenField ID="hdnMAPID" runat="server" Value="" />
                    <%-- 画面遷移用メッセージ --%>
                    <asp:HiddenField ID="hdnMsgId" runat="server" Value="" />
                    <%-- マスタ参照画面設定 --%>
                    <asp:HiddenField ID="hdnTankViewOpen" runat="server" Value="0" EnableViewState="false" />
                    <asp:HiddenField ID="hdnTankViewUrl"  runat="server" Value="" />
                    <%-- 備考欄ボックス --%>
