<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00004CUSTOMER.aspx.vb" Inherits="OFFICE.GBM00004CUSTOMER" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewCustomerType = '<%= Me.vLeftCustomerType.ClientID %>';      /* 顧客種類 */
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ...
                                           ['<%= Me.lbCustomerType.ClientID %>', '3', '1'],
            ...
            //終了ボタン
            if (document.getElementById('<%= Me.hdnMsgboShowFlg.ClientID %>').value == "1"){
                document.getElementById('divRemarkInputBoxWrapper').style.display = 'block';
            }
            setDisplayNameTip();
            /* 共通一覧のスクロールイベント紐づけ */
            ...
            <div id="divContensbox">
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblNamesenEx" runat="server" Text="名称（短）英語" Font-Bold="True"></asp:Label>
                            <asp:TextBox ID="txtNamesenEx" runat="server" ></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div id="detailStaticbox">
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabCustomer" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabCustomer" runat="server" Text="顧客情報" ></asp:Label>
                        </a>
                    </div>
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
                ...
                <div id="divHidden">
                    ...
                    <asp:HiddenField ID="hdnMsgboShowFlg" Value="0" runat="server" />
                    <%-- 詳細ボックス開閉情報保持用 --%>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  顧客種類 --%>
                    <asp:View id="vLeftCustomerType" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCustomerType" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 顧客種類 VIEW --%>
                    <%--  経理円貨外貨区分コード --%>
            ...
            <div id="divRemarkInputBoxWrapper" runat="server">
                <div id="divRemarkInputBox">
                    ...
                    <div id="divRemarkInputButtons">
                        ...
                        <input id="btnRemarkInputCancel" type="button" value="CANCEL" runat="server" onclick="document.getElementById('divRemarkInputBoxWrapper').style.display = 'none'; document.getElementById('hdnMsgboShowFlg').value = '0';" />
                    </div>
                </div>
            </div>
        </div>
