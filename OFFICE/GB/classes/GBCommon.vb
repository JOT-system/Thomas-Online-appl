...
Public Structure GBA00012TankInfo
    ...
    Public Sub GBA00012getTankStatusTable()
        ...
        Try
            ...
            sqlStat.AppendLine("        RANK() OVER(PARTITION BY OVSTAT.TANKNO ORDER BY (CASE WHEN OVSTAT.ACTUALDATE = @InitDate THEN '9999/12/12' else OVSTAT.ACTUALDATE END) desc, convert(char(10),OVSTAT.INITYMD,111) desc, convert(int, OVSTAT.DISPSEQ) desc) as RECENT,")
