...
''' </summary>
Public Class GBT00024SELECT
    Inherits GbPageCommon

    Private Const CONST_MAPID As String = "GBT00024S"     '自身のMAPID
    Private Const CONST_BASEID As String = "GBT00024A"
    ...
    ''' </summary>
    ''' <returns></returns>
    Public Property ThisScreenValues As GBT00024SValues
    ''' <summary>
    ''' ページロード時処理
    ''' </summary>
    ...
    Private Sub LangSetting(ByVal lang As String)
        ...
        AddLangSetting(dicDisplayText, Me.lblYMD1, "リース期間", "Lease")
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBT00024APPROVAL Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBT00024APPROVAL Then
            ...
            '実行画面からの画面遷移
            Me.SetDispValue(prevPage.GBT00024SValues)
        End If
        'コードを元に名称を設定
        '荷主コード　
        txtShipper_Change()
    ...
    ''' </summary>
    ''' <returns></returns>
    Private Function GetDispValue() As GBT00024SValues
        Dim retVal As New GBT00024SValues
        ...
        retVal.Apploval = Me.txtApproval.Text
        retVal.ViewId = ""
    ...
    Private Sub SetDispValue(valClass As GBT00024SValues)
    ...
    Public Class GBT00024SValues
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Property Apploval As String = ""
        ''' <summary>
        ''' (右ボックス)ビューID
        ''' </summary>
        ''' <returns></returns>
