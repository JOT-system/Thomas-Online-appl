<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00006RESULTTST.aspx.vb" Inherits="OFFICE.GBT00006RESULTTST" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            //var dblClickObjects = [['<%-- Me.TextBox1.ClientID --%>',viewCalId],
            //                       ['<%-- Me.TextBox2.ClientID --%>', viewBreakerType]];
            ...
            var targetOnchangeObjects = ['<%-- Me.TextBox2.ClientID --%>'];
        ...
        <div id="divContainer">
            <div id="divTitlebox">
                <table id="tblTitlebox">
                    <tr>
                        ...
                        <td rowspan="2">
                            <span style="color:red;">TEST </span><asp:Label ID="lblTitleText" runat="server" Text=""></asp:Label>
                        </td>
                        <td >
            ...
            <div id="divContensbox">
                <div id="actionButtonsBox">
                    <input id="btnExtract" type="button" value="絞り込み"  runat="server"  style="display:none;" />
                    <input id="btnExcelDownload" type="button" value="Excelダウンロード"  runat="server" style="display:none;" />
                    <input id="btnAllocate" type="button" value="引当"  runat="server" style="display:none;" />
                    <input id="btnSave" type="button" value="保存"  runat="server" visible="false" style="display:none;"  />
                ...
                <div style="display:none;">
                    <span>
                        ...
                        <asp:TextBox ID="txtPort" runat="server" Text=""></asp:TextBox>
                    </span>
                    <span id="spnAlocTankInfo" runat="server">
                        <asp:Label ID="lblAllocateTankCount" runat="server" Text=""></asp:Label>
                        <span>
                            <asp:Label ID="lblAllocateTankSelectedCount" runat="server" Text=""></asp:Label>/<asp:Label ID="lblAllocateTankMaxCount" runat="server" Text=""></asp:Label>
                        </span>
                    </span>
                    <span id="spnActy2" runat="server" visible="false">
                        <asp:Label ID="lblActyV2" runat="server" Text="Acty V2"></asp:Label>
                        <asp:CheckBoxList ID="cblActy2" runat="server"></asp:CheckBoxList>
                    </span>
                </div>
                <!-- タンク動静、引き当て一覧 -->
