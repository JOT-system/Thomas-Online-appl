...
''' COSTUP検索画面クラス
''' </summary>
Public Class GBT00015SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBT00015S"     '自身のMAPID
    Private Const CONST_BASEID As String = "GBT00015"
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBT00015RESULT Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBT00015RESULT Then
            Dim prevPage As GBT00015RESULT = DirectCast(Page.PreviousPage, GBT00015RESULT)
            '実行画面からの画面遷移
            '○画面項目設定（セッション変数より）処理
    ...
    Public Sub checkProc()
        ...
        'ETD開始日 単項目チェック
        Dim etdStStr As String = FormatDateYMD(txtETDStYMD.Text, GBA00003UserSetting.DATEFORMAT)
        ...
        'ETD終了日 単項目チェック
        Dim etdEndStr As String = FormatDateYMD(txtETDEndYMD.Text, GBA00003UserSetting.DATEFORMAT)
        ...
        'ETA開始日 単項目チェック
        Dim etaStStr As String = FormatDateYMD(txtETAStYMD.Text, GBA00003UserSetting.DATEFORMAT)
        ...
        'ETA終了日 単項目チェック
        Dim etaEndStr As String = FormatDateYMD(txtETAEndYMD.Text, GBA00003UserSetting.DATEFORMAT)
