<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00020EXRATE.aspx.vb" Inherits="OFFICE.GBM00020EXRATE" %>
<!DOCTYPE html>
...
<%--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162522994-1"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewCountryCodeExId = '<%= Me.vLeftCountryCodeEx.ClientID %>';  /* 国コード(絞り込み) */
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ...
                                           ['<%= Me.lbCountryCodeEx.ClientID %>', '3', '1']];
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblCountryCodeEx" runat="server" Text="国コード"></asp:Label>
                            <asp:TextBox ID="txtCountryCodeEx" runat="server" ></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            ...
                            <%-- 通貨コード --%>
                            <a id="stCurrencyCode">
                                <asp:Label ID="lblCurrencyCode" runat="server" Text="通貨コード" CssClass="textLeft " ></asp:Label>
                                <%--<asp:TextBox ID="txtCurrencyCode" runat="server" Height="1.1em" Width="15em" CssClass="textCss"></asp:TextBox>--%>
                                <asp:Label ID="lblCurrencyCodeText" runat="server" CssClass="textLeft"></asp:Label>
                                <%--<asp:Label ID="lblCurrencyCodeText" runat="server" Height="1.1em" Width="15em" CssClass="textLeftLabel"></asp:Label>--%>
                            </a>
                        </div>
                        <div class="detailInputRow">
                            <%-- 対象年月 --%>
                            <a id="stTargetDate">
                                <asp:Label ID="lblTargetDate" runat="server" Text="対象年月" CssClass="textLeft requiredMark" ></asp:Label>
                                <asp:TextBox ID="txtTargetDate" runat="server" CssClass="textCss" MaxLength="7"></asp:TextBox>
                                <asp:Label ID="lblTargetDateText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 削除フラグ --%>
                            <a id="stDelFlg">
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabExRate" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabExRate" runat="server" Text="為替レート情報" ></asp:Label>
                        </a>
                    </div>
...
<%--                                        <asp:Label ID="WF_Rep1_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  　国コード(絞り込み)　 --%>
                    <asp:View id="vLeftCountryCodeEx" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCountryCodeEx" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 国コード(絞り込み) VIEW　 --%>
                    <%--  会社コード --%>
