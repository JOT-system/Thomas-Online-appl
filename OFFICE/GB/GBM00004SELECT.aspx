<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00004SELECT.aspx.vb" Inherits="OFFICE.GBM00004SELECT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewCustomerCodeId = '<%= Me.vLeftCustomerCode.ClientID %>';                    /* 顧客コード */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ...
                                   ['<%= Me.txtCustomerCode.ClientID %>', viewCustomerCodeId]
                                  ];
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbCountryCode.ClientID %>', '3', '1'],
                                           ['<%= Me.lbCustomerCode.ClientID %>', '3', '1']];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [
                                         ['<%= Me.txtCountryCode.ClientID %>'],
                                         ['<%= Me.txtCustomerCode.ClientID %>']
                                        ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00004S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblCountryCode" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtCountryCode" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblCountryCodeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                    <%-- 顧客コード --%>
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblCustomerCode" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtCustomerCode" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblCustomerCodeText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <%--  顧客コード --%>
                    <asp:View id="vLeftCustomerCode" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCustomerCode" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
