<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00023SELECT.aspx.vb" Inherits="OFFICE.GBM00023SELECT" %>
<!DOCTYPE html>
...
<%--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162522994-1"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewTransportPatternId = '<%= Me.vLeftTransportPattern.ClientID %>';    /* 輸送パターン */
            var dblClickObjects = [['<%= Me.txtStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtTransportPattern.ClientID %>', viewTransportPatternId]
                                  ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00023S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblTransportPattern" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtTransportPattern" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblTransportPatternText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
                ...
                <div id="divHidden">
                    ...
                    <%-- ブレーカータイプ保持用 --%>
                    <asp:HiddenField ID="hdnBreakerTypeValue" Value="" runat="server" Visible="false" />
                    <asp:HiddenField ID="hdnBreakerTypeItem" Value="" runat="server" Visible="false" />
                </div>
            </div>
            <%-- 左ボックス --%>
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    <%--  輸送パターン --%>
                    <asp:View id="vLeftTransportPattern" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbTransportPattern" runat="server" CssLevel1="leftViewContents"></asp:ListBox>
                        </div>
