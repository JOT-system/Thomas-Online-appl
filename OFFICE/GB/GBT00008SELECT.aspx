<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00008SELECT.aspx.vb" Inherits="OFFICE.GBT00008SELECT" %>
...
<head runat="server">
    ...
    <style>
       ...
       #itemTable tr:nth-child(5) td:nth-child(1){
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var dblClickObjects = [['<%= Me.txtDateTermStYMD.ClientID %>', viewCalId],
                                   ['<%= Me.txtDateTermEndYMD.ClientID %>', viewCalId],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00008S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblSettleType" runat="server" Text="検索方法"></asp:Label>
                        </td>
                        <td colspan="3">
                            <asp:RadioButtonList ID="rblSettleType" runat="server" RepeatLayout="UnorderedList">
                                <asp:ListItem Text="未精算" Value="01NOTSETTLED"></asp:ListItem>
                                <asp:ListItem Text="精算" Value="02SETTLED"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td>
                            &nbsp;
	                ...
	                <tr style="display:none;">
		                <td>
			                <asp:Label ID="lblDateTerm1" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:Label ID="lblDateTerm2" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtDateTermStYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblDateTermTitle" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtDateTermEndYMD" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
			                <a><asp:Label ID="lblTankNoText" runat="server" ></asp:Label></a>
		                </td>
	                </tr>
                    <%-- 承認コード --%> 
                    <tr>
