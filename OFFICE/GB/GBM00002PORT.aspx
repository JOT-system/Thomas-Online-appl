<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00002PORT.aspx.vb" Inherits="OFFICE.GBM00002PORT" %>
<!DOCTYPE html>
                ...
                <div class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblAreaNameEx" runat="server" Text="エリア名"></asp:Label>
                            <asp:TextBox ID="txtAreaNameEx" runat="server" ></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div id="detailStaticbox">
                        ...
                        <div class="detailInputRow">
                            <%-- 港コード --%>
                            <a id="stPortCode">
                                <asp:Label ID="lblPortCode" runat="server" Text="港コード" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtPortCode" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblPortCodeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        ...
                        <div class="detailInputRow">
                            <%-- エリアコード --%>
                            <a id="stAreaCode">
                                <asp:Label ID="lblAreaCode" runat="server" Text="エリアコード" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtAreaCode" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblAreaCodeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabPort" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabPort" runat="server" Text="港情報"></asp:Label>
                        </a>
                    </div>
