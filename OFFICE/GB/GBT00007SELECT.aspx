<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00007SELECT.aspx.vb" Inherits="OFFICE.GBT00007SELECT" %>
...
<%--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162522994-1"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbApproval.ClientID %>', '3', '1'],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00007S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
