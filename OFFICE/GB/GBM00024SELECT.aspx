<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00024SELECT.aspx.vb" Inherits="OFFICE.GBM00024SELECT" %>
<!DOCTYPE html>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewTransportPatternId = '<%= Me.vLeftTransportPattern.ClientID %>';                      /* 取引先区分 */
             ...
             */ 
            var leftListExtentionTarget = [['<%= Me.lbTransportPattern.ClientID %>', '3', '1'],
                                           ];
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00024S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <asp:View id="vLeftTransportPattern" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbTransportPattern" runat="server" CssToriCode="leftViewContents"></asp:ListBox>
                        </div>
