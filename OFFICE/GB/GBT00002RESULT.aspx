<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00002RESULT.aspx.vb" Inherits="OFFICE.GBT00002RESULT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00002RESULT.css" rel="stylesheet" />
    <style>
    ...
    <script type="text/javascript">
        ...
        function listButtonClick(obj) {
            ...
            if (document.getElementById('hdnSubmit').value === 'FALSE') {
                ...
                objButtonClick.value = 'btnListAction';
                commonDispWait();
                document.forms[0].submit();                             //aspx起動
            };
            return false;
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00002R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <div id="actionButtonsBox">
                    ...
                    <input id="btnCreateSales" type="button" value="セールス新規作成" runat="server" />
                    <input id="btnCreateOperation" type="button" value="オペ新規作成"  runat="server" />
                    ...
                    <div id="btnPREV" class="PrePage" runat="server"></div>
                    <div id="btnNEXT" class="NextPage" runat="server"></div>
                ...
                <div id="selectHeaderBox" runat="server">
                    <div id="divSearchConditionBox">
                        ...
                        <span>
                            <asp:Label ID="lblBreaker" runat="server" Text="Breaker ID"></asp:Label>
                            <asp:TextBox ID="txtBreaker" runat="server" Text=""></asp:TextBox>
                            <%--<asp:Label ID="lblBreakerText" runat="server" Text="" Visible="false"></asp:Label>--%>
                        </span> 
                        <span>
                            <asp:Label ID="lblApproval" runat="server" Text="Status"></asp:Label>
                            <asp:TextBox ID="txtApproval" runat="server" Text=""></asp:TextBox>
                            <asp:Label ID="lblApprovalText" runat="server" Text=""></asp:Label>
                        </span>
                    </div>
                </div>
                ...
                <div id="divHidden">
                    ...
                    <%-- 次画面(単票画面)引き渡し情報 --%>
                    <asp:HiddenField ID="hdnSelectedBrId" runat="server" Value="" Visible="False" />  <%--  一覧ダブルクリックしたBRID --%>
                    <asp:HiddenField ID="hdnBreakerType" runat="server" Value="" Visible="False" /> 
                    <asp:HiddenField ID="hdnTransferPattern" runat="server" Value="" Visible="False" />
                    ...
                    <%-- Complete --%>
                    <asp:HiddenField ID="hdnComplete"  runat="server" Value="" Visible="False" />
                </div>
            </div>
            <%-- 左ボックス --%>
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <asp:View ID="vLeftPOD" runat="server">
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbPOD" runat="server"></asp:ListBox>
                        </div>
