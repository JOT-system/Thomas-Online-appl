...
''' 国マスタ画面クラス
''' </summary>
Public Class GBM00001COUNTRY
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00001"    '自身のMAPID
    Private Const CONST_BASEDATATABLE = "GBM00001TBL"
    Private Const CONST_INPDATATABLE = "GBM00001INPTBL"
    Private Const CONST_UPDDATATABLE = "GBM00001UPDTBL"
    Private Const CONST_PDFDATATABLE = "GBM00001PDFTBL"
    Private Const CONST_DSPROWCOUNT = 44                '指定数＋１が表示対象
    Private Const CONST_SCROLLROWCOUNT = 8              'マウススクロール時の増分
    Private Const CONST_TBLMASTER = "GBM0001_COUNTRY"
    Private Const CONST_TBLAPPLY = "GBM0015_COUNTRYAPPLY"
    Private Const CONST_EVENTCODE = "MasterApplyCountry"
    ...
    Protected Sub GetListData()
        ...
        Try
            ...
            SQLStr =
                ...
                & "       isnull(rtrim(TAXRATE),'')                  as TAXRATE , " _
                & "       isnull(rtrim(DATEFORMAT),'')               as DATEFORMAT , " _
                & "       isnull(rtrim(DECIMALPLACES),'')            as DECIMALPLACES , " _
                & "       isnull(rtrim(RATEDECIMALPLACES),'')        as RATEDECIMALPLACES , " _
                & "       isnull(rtrim(ROUNDFLG),'')                 as ROUNDFLG , " _
                & "       isnull(rtrim(DEBITSEGMENT),'')             as DEBITSEGMENT , " _
                ...
                & "       isnull(rtrim(OFFICENAME),'')               as OFFICENAME , " _
                & "       isnull(rtrim(MAIL_COUNTRY),'')             as MAIL_COUNTRY , " _
                & "       isnull(rtrim(MAIL_MONTHLYREPORT),'')       as MAIL_MONTHLYREPORT , " _
                & "       isnull(rtrim(REMARKS),'')                  as REMARKS , " _
                ...
                & " FROM GBM0001_COUNTRY as tbl1 " _
                & " WHERE DELFLG    <> @P4 " _
                & " AND   STYMD     <= @P1 " _
                & " AND   ENDYMD    >= @P2 " _
                & " AND   NOT EXISTS( "
            ...
            If Page.PreviousPage Is Nothing Then
                SQLStr &= " SELECT * FROM GBM0015_COUNTRYAPPLY as tbl2 " _
            ...
            SQLStr &= " )" _
                ...
                & "       isnull(rtrim(COMPCODE),'')                 as COMPCODE , " _
                & "       isnull(rtrim(ORGCODE),'')              as COUNTRYCODE , " _
                & "       isnull(convert(nvarchar, STYMD , 111),'')  as STYMD , " _
                & "       isnull(convert(nvarchar, ENDYMD , 111),'') as ENDYMD , " _
                & "       isnull(rtrim(COUNTRYCODE),'')              as COUNTRYCODE , " _
                & "       isnull(rtrim(NAMES),'')                    as NAMES , " _
                ...
                Try
                    ...
                    If (Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = updateDisp OrElse Convert.ToString(BASEtbl.Rows(i)("OPERATION")) = "★" & updateDisp) Then
                        ...
                        SQLStr = SQLStr & " ENDYMD = @P05 , " _
                                 ...
                                 & "        DATEFORMAT = @P13 , " _
                                 & "        DECIMALPLACES = @P14 , " _
                                 & "        RATEDECIMALPLACES = @P15 , " _
                                 & "        ROUNDFLG = @P16 , " _
                                 & "        DEBITSEGMENT = @P24 , " _
                                 & "        ACCCURRENCYSEGMENT = @P25 , " _
                                 & "        BOTHCLASS = @P26 , " _
                                 & "        TORICOMP = @P27 , " _
                                 & "        INCTORICODE = @P28 , " _
                                 & "        EXPTORICODE = @P29 , " _
                        ...
                        SQLStr = SQLStr & "         @P02,@P03,@P04,@P05,@P06,     @P07,@P08,@P09,@P10, " _
                                 & "           @P11,@P12,@P13,@P14,@P15,@P16,@P24,@P25,@P26,@P27,@P28,@P29,@P30, " _
                                 & "           @P31,@P32,@P33,@P34,@P35,@P36,@P37,@P17,@P18,@P19,@P20,@P21,@P22,@P23); " _
                                 & " CLOSE timestamp ; " _
                        ...
                        Dim PARA12 As SqlParameter = SQLcmd.Parameters.Add("@P12", System.Data.SqlDbType.Float)
                        Dim PARA13 As SqlParameter = SQLcmd.Parameters.Add("@P13", System.Data.SqlDbType.NVarChar)
                        Dim PARA14 As SqlParameter = SQLcmd.Parameters.Add("@P14", System.Data.SqlDbType.Int)
                        Dim PARA15 As SqlParameter = SQLcmd.Parameters.Add("@P15", System.Data.SqlDbType.Int)
                        ...
                        Dim PARA19 As SqlParameter = SQLcmd.Parameters.Add("@P19", System.Data.SqlDbType.DateTime)
                        ...
                        Dim PARA31 As SqlParameter = SQLcmd.Parameters.Add("@P31", System.Data.SqlDbType.Int)
                        Dim PARA32 As SqlParameter = SQLcmd.Parameters.Add("@P32", System.Data.SqlDbType.NVarChar)
                        Dim PARA33 As SqlParameter = SQLcmd.Parameters.Add("@P33", System.Data.SqlDbType.Int)
                        ...
                        PARA09.Value = BASEtbl.Rows(i)("NAMESJP")
                        PARA10.Value = BASEtbl.Rows(i)("NAMELJP")
                        PARA11.Value = BASEtbl.Rows(i)("CURRENCYCODE")
                        PARA12.Value = BASEtbl.Rows(i)("TAXRATE")
                        PARA13.Value = BASEtbl.Rows(i)("DATEFORMAT")
                        PARA14.Value = BASEtbl.Rows(i)("DECIMALPLACES")
                        PARA15.Value = BASEtbl.Rows(i)("RATEDECIMALPLACES")
                        PARA16.Value = BASEtbl.Rows(i)("ROUNDFLG")
                        PARA24.Value = BASEtbl.Rows(i)("DEBITSEGMENT")
                        PARA25.Value = BASEtbl.Rows(i)("ACCCURRENCYSEGMENT")
                        PARA26.Value = BASEtbl.Rows(i)("BOTHCLASS")
                        PARA27.Value = BASEtbl.Rows(i)("TORICOMP")
                        PARA28.Value = BASEtbl.Rows(i)("INCTORICODE")
                        PARA29.Value = BASEtbl.Rows(i)("EXPTORICODE")
                        PARA30.Value = BASEtbl.Rows(i)("DEPOSITDAY")
                        PARA31.Value = BASEtbl.Rows(i)("DEPOSITADDMM")
                        PARA32.Value = BASEtbl.Rows(i)("OVERDRAWDAY")
                        PARA33.Value = BASEtbl.Rows(i)("OVERDRAWADDMM")
                        PARA34.Value = BASEtbl.Rows(i)("HOLIDAYFLG")
                        PARA35.Value = BASEtbl.Rows(i)("OFFICENAME")
                        PARA36.Value = BASEtbl.Rows(i)("MAIL_COUNTRY")
                        PARA37.Value = BASEtbl.Rows(i)("MAIL_MONTHLYREPORT")
                        PARA17.Value = BASEtbl.Rows(i)("REMARKS")
                        PARA18.Value = BASEtbl.Rows(i)("DELFLG")
                        PARA19.Value = nowDate
                        PARA20.Value = nowDate
                        PARA21.Value = COA0019Session.USERID
                        PARA22.Value = HttpContext.Current.Session("APSRVname")
                        PARA23.Value = CONST_DEFAULT_RECEIVEYMD
                        ...
                        Dim PARA1 As SqlParameter = SQLcmd2.Parameters.Add("@P01", System.Data.SqlDbType.Char, 10)
                        Dim PARA2 As SqlParameter = SQLcmd2.Parameters.Add("@P02", System.Data.SqlDbType.Char, 10)
    ...
    Protected Sub INPtblCheck()
        ...
        '事前準備（キー重複レコード削除）
        Dim dupCheckFields = CommonFunctions.CreateCompareFieldList({"COMPCODE", "ORGCODE", "STYMD"})
        ...
        For i As Integer = INPtbl.Rows.Count - 1 To 1 Step -1
            ...
            '   Convert.ToString(drCurrent("ORGCODE")) = Convert.ToString(drBefor("ORGCODE")) AndAlso
        ...
        For i As Integer = 0 To INPtbl.Rows.Count - 1
            ...
            Else
                ...
                Dim compareFieldList = CommonFunctions.CreateCompareFieldList({"COMPCODE", "ORGCODE"})
                ...
                For j As Integer = 0 To BASEtbl.Rows.Count - 1
                    ...
                    If Convert.ToString(dr("DELFLG")) <> BaseDllCommon.CONST_FLAG_YES Then
                        ...
                        '       Convert.ToString(BASEtbl.Rows(j)("ORGCODE")) = Convert.ToString(workInpRow("ORGCODE")) Then
    ...
    Private Sub LangSetting(ByVal lang As String)
        ...
        AddLangSetting(dicDisplayText, Me.lblNamesEx, "国名称", "Country Name")
        ...
        '****************************************
        If (COA0019Session.LANGDISP <> C_LANG.JA) Then
            Me.lblDtabCountry.Text = "Country Info"
        Else
            Me.lblDtabCountry.Text = "国情報"
        End If
    ...
    Protected Sub BASEtblColumnsAdd(table As DataTable)
        ...
        table.Columns("CURRENCYCODE").DefaultValue = ""
        table.Columns.Add("TAXRATE", GetType(String))
        table.Columns("TAXRATE").DefaultValue = "0"
        table.Columns.Add("DATEFORMAT", GetType(String))
        table.Columns("DATEFORMAT").DefaultValue = ""
        table.Columns.Add("DECIMALPLACES", GetType(String))
        table.Columns("DECIMALPLACES").DefaultValue = "3"
        table.Columns.Add("RATEDECIMALPLACES", GetType(String))
        table.Columns("RATEDECIMALPLACES").DefaultValue = "6"
        table.Columns.Add("ROUNDFLG", GetType(String))
        table.Columns("ROUNDFLG").DefaultValue = ""
        table.Columns.Add("DEBITSEGMENT", GetType(String))
        table.Columns("DEBITSEGMENT").DefaultValue = ""
        ...
        table.Columns("DEPOSITADDMM").DefaultValue = "0"
        ...
        table.Columns("OVERDRAWADDMM").DefaultValue = "0"
        table.Columns.Add("HOLIDAYFLG", GetType(String))
        table.Columns("HOLIDAYFLG").DefaultValue = ""
        table.Columns.Add("OFFICENAME", GetType(String))
        table.Columns("OFFICENAME").DefaultValue = ""
        table.Columns.Add("MAIL_COUNTRY", GetType(String))
        table.Columns("MAIL_COUNTRY").DefaultValue = ""
        table.Columns.Add("MAIL_MONTHLYREPORT", GetType(String))
        table.Columns("MAIL_MONTHLYREPORT").DefaultValue = ""
        table.Columns.Add("REMARKS", GetType(String))
        table.Columns("REMARKS").DefaultValue = ""
        table.Columns.Add("DELFLG", GetType(String))
        table.Columns("DELFLG").DefaultValue = "0"
    ...
    Protected Sub DefaultToTBL(argTbl As DataTable)
        ...
        workRow("TAXRATE") = "0"
        workRow("DATEFORMAT") = ""
        workRow("DECIMALPLACES") = "0"
        workRow("RATEDECIMALPLACES") = "0"
        workRow("ROUNDFLG") = ""
        workRow("DEBITSEGMENT") = ""
        ...
        workRow("HOLIDAYFLG") = ""
        workRow("OFFICENAME") = ""
        workRow("MAIL_COUNTRY") = ""
        workRow("MAIL_MONTHLYREPORT") = ""
        workRow("REMARKS") = ""
        workRow("DELFLG") = ""
        workRow("UPDYMD") = ""
        workRow("UPDUSER") = ""
    ...
    Protected Sub detailboxInit()
        ...
        lblDtabCountry.Style.Remove("color")
        lblDtabCountry.Style.Add("color", "blue")
        lblDtabCountry.Style.Remove("background-color")
        lblDtabCountry.Style.Add("background-color", "rgb(220,230,240)")
        lblDtabCountry.Style.Remove("border")
        lblDtabCountry.Style.Add("border", "1px solid blue")
        lblDtabCountry.Style.Remove("font-weight")
        lblDtabCountry.Style.Add("font-weight", "bold")
    ...
    Protected Sub CheckSingle(ByVal argRow As DataRow, ByRef argEscFlg As Boolean)
        ...
        Dim COA0008InvalidChar As New BASEDLL.COA0008InvalidChar        '例外文字排除 String Get
        Dim skipInvCharFields As New List(Of String) From {"MAIL_COUNTRY", "MAIL_MONTHLYREPORT"}
    ...
    Private Sub SetOrgCodeListItem(selectedValue As String)
        ...
        Try
            ...
            GBA00007OrganizationRelated.LISTBOX_ORG_COUNTRY = Me.lbOrgCode
            ...
            If GBA00007OrganizationRelated.ERR = C_MESSAGENO.NORMAL OrElse GBA00007OrganizationRelated.ERR = C_MESSAGENO.NODATA Then
                Me.lbOrgCode = DirectCast(GBA00007OrganizationRelated.LISTBOX_ORG_COUNTRY, ListBox)
            Else
    ...
    Protected Sub BASEtblUpdate()
        ...
        Dim compareUpdTargetFieldList = CommonFunctions.CreateCompareFieldList({"COMPCODE", "ORGCODE", "STYMD"})
        Dim compareModFieldList = CommonFunctions.CreateCompareFieldList({"ENDYMD", "COUNTRYCODE", "NAMES", "NAMEL", "NAMESJP",
                                                                          "NAMELJP", "CURRENCYCODE", "TAXRATE", "DATEFORMAT", "DECIMALPLACES",
                                                                          "RATEDECIMALPLACES", "ROUNDFLG", "DEBITSEGMENT", "ACCCURRENCYSEGMENT", "BOTHCLASS",
                                                                          "TORICOMP", "INCTORICODE", "EXPTORICODE", "DEPOSITDAY", "DEPOSITADDMM",
                                                                          "OVERDRAWDAY", "OVERDRAWADDMM", "HOLIDAYFLG", "OFFICENAME", "MAIL_COUNTRY", "MAIL_MONTHLYREPORT",
                                                                          "REMARKS", "DELFLG"})
        ...
        For i As Integer = 0 To INPtbl.Rows.Count - 1
            ...
            If Convert.ToString(drInput("HIDDEN")) <> "1" Then ' "1" ・・・取り込み対象外エラー
                ...
                For j As Integer = 0 To BASEtbl.Rows.Count - 1
                    ...
                    ' 更新対象検索
                    'If Convert.ToString(workBaseRow("COMPCODE")) = Convert.ToString(drInput("COMPCODE")) AndAlso
                    '   Convert.ToString(workBaseRow("ORGCODE")) = Convert.ToString(drInput("ORGCODE")) AndAlso
                    '   Convert.ToString(workBaseRow("STYMD")) = Convert.ToString(drInput("STYMD")) Then
                    If CommonFunctions.CompareDataFields(workBaseRow, drInput, compareUpdTargetFieldList) Then
                        ...
                        If Convert.ToString(drInput("OPERATION")) <> errDisp AndAlso
                            ...
                            'Convert.ToString(workBaseRow("ENDYMD")) = Convert.ToString(drInput("ENDYMD")) AndAlso
                            'Convert.ToString(workBaseRow("COUNTRYCODE")) = Convert.ToString(drInput("COUNTRYCODE")) AndAlso
                            'Convert.ToString(workBaseRow("NAMES")) = Convert.ToString(drInput("NAMES")) AndAlso
                            'Convert.ToString(workBaseRow("NAMEL")) = Convert.ToString(drInput("NAMEL")) AndAlso
                            'Convert.ToString(workBaseRow("NAMESJP")) = Convert.ToString(drInput("NAMESJP")) AndAlso
                            'Convert.ToString(workBaseRow("NAMELJP")) = Convert.ToString(drInput("NAMELJP")) AndAlso
                            'Convert.ToString(workBaseRow("CURRENCYCODE")) = Convert.ToString(drInput("CURRENCYCODE")) AndAlso
                            'Convert.ToString(workBaseRow("TAXRATE")) = Convert.ToString(drInput("TAXRATE")) AndAlso
                            'Convert.ToString(workBaseRow("DATEFORMAT")) = Convert.ToString(drInput("DATEFORMAT")) AndAlso
                            'Convert.ToString(workBaseRow("DECIMALPLACES")) = Convert.ToString(drInput("DECIMALPLACES")) AndAlso
                            'Convert.ToString(workBaseRow("RATEDECIMALPLACES")) = Convert.ToString(drInput("RATEDECIMALPLACES")) AndAlso
                            'Convert.ToString(workBaseRow("ROUNDFLG")) = Convert.ToString(drInput("ROUNDFLG")) AndAlso
                            'Convert.ToString(workBaseRow("DEBITSEGMENT")) = Convert.ToString(drInput("DEBITSEGMENT")) AndAlso
                            'Convert.ToString(workBaseRow("ACCCURRENCYSEGMENT")) = Convert.ToString(drInput("ACCCURRENCYSEGMENT")) AndAlso
                            'Convert.ToString(workBaseRow("BOTHCLASS")) = Convert.ToString(drInput("BOTHCLASS")) AndAlso
                            'Convert.ToString(workBaseRow("TORICOMP")) = Convert.ToString(drInput("TORICOMP")) AndAlso
                            'Convert.ToString(workBaseRow("INCTORICODE")) = Convert.ToString(drInput("INCTORICODE")) AndAlso
                            'Convert.ToString(workBaseRow("EXPTORICODE")) = Convert.ToString(drInput("EXPTORICODE")) AndAlso
                            'Convert.ToString(workBaseRow("DEPOSITDAY")) = Convert.ToString(drInput("DEPOSITDAY")) AndAlso
                            'Convert.ToString(workBaseRow("DEPOSITADDMM")) = Convert.ToString(drInput("DEPOSITADDMM")) AndAlso
                            'Convert.ToString(workBaseRow("OVERDRAWDAY")) = Convert.ToString(drInput("OVERDRAWDAY")) AndAlso
                            'Convert.ToString(workBaseRow("OVERDRAWADDMM")) = Convert.ToString(drInput("OVERDRAWADDMM")) AndAlso
                            'Convert.ToString(workBaseRow("HOLIDAYFLG")) = Convert.ToString(drInput("HOLIDAYFLG")) AndAlso
                            'Convert.ToString(workBaseRow("OFFICENAME")) = Convert.ToString(drInput("OFFICENAME")) AndAlso
                            'Convert.ToString(workBaseRow("MAIL_COUNTRY")) = Convert.ToString(drInput("MAIL_COUNTRY")) AndAlso
                            'Convert.ToString(workBaseRow("REMARKS")) = Convert.ToString(drInput("REMARKS")) AndAlso
                            'Convert.ToString(workBaseRow("DELFLG")) = Convert.ToString(drInput("DELFLG")) Then
                ...
                If workBasePos >= 0 Then
                    ...
                    For k As Integer = 0 To BASEtbl.Rows.Count - 1
                        ...
                        'If Convert.ToString(workBaseRow2("COMPCODE")) = Convert.ToString(drInput("COMPCODE")) AndAlso
                        '   Convert.ToString(workBaseRow2("ORGCODE")) = Convert.ToString(drInput("ORGCODE")) AndAlso
                        '   Convert.ToString(workBaseRow2("STYMD")) = Convert.ToString(drInput("STYMD")) Then
                    ...
                    If Convert.ToString(workBaseRow("OPERATION")) <> errDisp OrElse
                        ...
                        workBaseRow("CURRENCYCODE") = drInput("CURRENCYCODE")
                        workBaseRow("TAXRATE") = drInput("TAXRATE")
                        workBaseRow("DATEFORMAT") = drInput("DATEFORMAT")
                        workBaseRow("DECIMALPLACES") = drInput("DECIMALPLACES")
                        workBaseRow("RATEDECIMALPLACES") = drInput("RATEDECIMALPLACES")
                        workBaseRow("ROUNDFLG") = drInput("ROUNDFLG")
                        workBaseRow("DEBITSEGMENT") = drInput("DEBITSEGMENT")
                        ...
                        workBaseRow("OFFICENAME") = drInput("OFFICENAME")
                        workBaseRow("MAIL_COUNTRY") = drInput("MAIL_COUNTRY")
                        workBaseRow("MAIL_MONTHLYREPORT") = drInput("MAIL_MONTHLYREPORT")
                        workBaseRow("REMARKS") = drInput("REMARKS")
    ...
    Private Sub SetPrevDisplayValues()
        If TypeOf Page.PreviousPage Is GBM00001SELECT Then
            '検索画面の場合
            Dim prevObj As GBM00001SELECT = DirectCast(Page.PreviousPage, GBM00001SELECT)
