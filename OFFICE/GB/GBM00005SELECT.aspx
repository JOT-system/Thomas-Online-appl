<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00005SELECT.aspx.vb" Inherits="OFFICE.GBM00005SELECT" %>
<!DOCTYPE html>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBM00005S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
                    ...
                    <tr>
                        <td colspan="2">
                            <a><asp:Label ID="lblClass" runat="server"></asp:Label></a>
                        </td>
                        <td>
                            <a><asp:TextBox ID="txtClass" runat="server"></asp:TextBox></a>
                        </td>
                        <td colspan="2">
                            <a><asp:Label ID="lblClassText" runat="server" ></asp:Label></a>
                        </td>
                    </tr>
                </table>
