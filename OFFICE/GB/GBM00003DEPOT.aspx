<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBM00003DEPOT.aspx.vb" Inherits="OFFICE.GBM00003DEPOT" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var viewOrgCodeId = '<%= Me.vLeftOrgCode.ClientID %>';               /* 組織コード */
            ...
            ['<%= Me.txtOrgCode.ClientID %>', viewOrgCodeId],
            ...
            var leftListExtentionTarget = [['<%= Me.lbOperation.ClientID %>', '3', '1'],
                                           ...
                                           ['<%= Me.lbOrgCode.ClientID %>', '3', '1'],
                                           ['<%= Me.lbDelFlg.ClientID %>', '3', '1'],
                                           ['<%= Me.lbBillingMethods.ClientID %>', '3', '1'],
                                           ['<%= Me.lbCurrencyCode.ClientID %>', '3', '1']
                                           ];
            addLeftBoxExtention(leftListExtentionTarget);

            /* 画面テキストボックス変更イベントのバインド(変更検知したいテキストボックスIDを指定 */
            var targetOnchangeObjects = [
            ['<%= Me.txtOrgCode.ClientID %>'],
                ...
                <div  class="headerbox" id="headerbox">
                    <div id="actionButtonsBox" >
                        <div id="extractItem">
                            ...
                            <asp:Label ID="lblDepotNameEx" runat="server" Text="デポ名称"></asp:Label>
                            <asp:TextBox ID="txtDepotNameEx" runat="server" ></asp:TextBox>
                        </div>
                        <div id="buttonBox">
                ...
                <div  class="detailbox" id="detailbox">
                    <div id="detailStaticbox"> 
                        ...
                        <div class="detailInputRow">
                            ...
                            <%-- 組織コード --%>
                            <a id="stOrgCode">
                                <asp:Label ID="lblOrgCode" runat="server" Text="組織コード" CssClass="textLeft requiredMark"></asp:Label>
                        ...
                        <div class="detailInputRow">
                            <%-- デポコード --%>
                            <a id="stDepotCode">
                                <asp:Label ID="lblDepotCode" runat="server" Text="デポコード" CssClass="textLeft requiredMark"></asp:Label>
                                <asp:TextBox ID="txtDepotCode" runat="server" CssClass="textCss"></asp:TextBox>
                                <asp:Label ID="lblDepotCodeText" runat="server" CssClass="textLeftLabel"></asp:Label>
                            </a>
                            <%-- 削除フラグ --%>
                            <a id="stDelFlg">
                        ...
                        <%-- Dタブ --%>
                        <a id="stDtabDepot" onclick="masterDtabChange('0')">
                            <asp:Label ID="lblDtabDepot" runat="server" Text="デポ情報"></asp:Label>
                        </a>
                        <a id="stDtabStorage" onclick="masterDtabChange('1')">
                            <asp:Label ID="lblDtabStorage" runat="server" Text="Storage Cost"></asp:Label>
                        </a>
                        <a id="stDtabAccounting" onclick="masterDtabChange('2')">
                            <asp:Label ID="lblDtabAccounting" runat="server" Text="Accounting"></asp:Label>
                        </a>
                    </div>
                            ...
                            <span class="WF_DViewRep3_Area" id="WF_DViewRep3_Area">
                               <asp:Repeater ID="WF_DViewRep3" runat="server">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td>
                                            <%-- 項目(名称)　左Side --%>
                                            <asp:Label ID="WF_Rep3_FIELDNM_1" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label1_1" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 項目(記号名)　左Side --%>
                                            <asp:Label ID="WF_Rep3_FIELD_1" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値　左Side --%>
                                            <asp:TextBox ID="WF_Rep3_VALUE_1" runat="server" CssClass="WF_TEXTBOX_repCSS"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label2_1" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値（名称）　左Side --%>
                                            <asp:Label ID="WF_Rep3_VALUE_TEXT_1" runat="server" CssClass="textLeftLabel"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- スペース --%>
                                            <asp:Label ID="WF_Rep3_Label3_1" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 項目(名称)　中央 --%>
                                            <asp:Label ID="WF_Rep3_FIELDNM_2" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label1_2" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 項目(記号名)　中央 --%>
                                            <asp:Label ID="WF_Rep3_FIELD_2" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値　中央 --%>
                                            <asp:TextBox ID="WF_Rep3_VALUE_2" runat="server" CssClass="WF_TEXTBOX_repCSS"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label2_2" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値（名称）　中央 --%>
                                            <asp:Label ID="WF_Rep3_VALUE_TEXT_2" runat="server" CssClass="textLeftLabel"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- スペース --%>
                                            <asp:Label ID="WF_Rep3_Label3_2" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 項目(名称)　右Side --%>
                                            <asp:Label ID="WF_Rep3_FIELDNM_3" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label1_3" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 項目(記号名)　右Side --%>
                                            <asp:Label ID="WF_Rep3_FIELD_3" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値　右Side --%>
                                            <asp:TextBox ID="WF_Rep3_VALUE_3" runat="server" CssClass="WF_TEXTBOX_repCSS"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="WF_Rep3_Label2_3" runat="server" Text="" CssClass="textLeft"></asp:Label>
                                        </td>
                                        <td>
                                            <%-- 値（名称）　右Side --%>
                                            <asp:Label ID="WF_Rep3_VALUE_TEXT_3" runat="server" CssClass="textLeftLabel"></asp:Label>
                                        </td>
                                        </tr>
<%--                                        <asp:Label ID="WF_Rep3_LINE" runat="server" Height="1px" Width="100%" style="display:none; border-bottom:solid; border-width:2px; border-color:blue;"></asp:Label>--%>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </table>
                                    </FooterTemplate>
                ...
                <div id="divHidden">
                    ...
                    <%-- 前画面選択条件 --%>
                    <asp:HiddenField ID="hdnSelectedOrgCode" runat="server" Value="" />
            ...
            <div id="divLeftbox">
                ...
                <asp:MultiView ID="mvLeft" runat="server">
                    ...
                    <asp:View id="vLeftCurrencyCode" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbCurrencyCode" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 通貨コード VIEW --%>
                    <%--  請求方法 --%>
                    <asp:View id="vLeftBillingMethods" runat="server" >
                        <div class="leftViewContents">
                            <asp:ListBox ID="lbBillingMethods" runat="server" CssClass="leftViewContents"></asp:ListBox>
                        </div>
                    </asp:View> <%-- END 請求方法 VIEW --%>                    
                    <%--  削除フラグ --%>
