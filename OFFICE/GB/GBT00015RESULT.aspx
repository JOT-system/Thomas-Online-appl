<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00015RESULT.aspx.vb" Inherits="OFFICE.GBT00015RESULT" %>
...
<head runat="server">
    ...
    <link href="~/GB/css/GBT00015RESULT.css" rel="stylesheet" />
    <style>
        #divBreakerInfo {
            height:100%;
            width:100%;
    ...
    <%--個別のスクリプトは以下に記載 --%>
    <script type="text/javascript" src='<%= ResolveUrl("~/GB/script/GBT00015RESULT.js") %>'  charset="utf-8"></script>
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00015R" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
                ...
                <div id="tankSelectHeaderBox" runat="server">
                    <div id="divSearchConditionBox">
                        ...
                        <span>
                            ...
                            <asp:TextBox ID="txtOrder" runat="server" Text=""></asp:TextBox>
                            <%--<asp:Label ID="lblOrderText" runat="server" Text="" Visible="false"></asp:Label>--%>
                        </span> 
                        <span>
