...
''' 港検索画面クラス
''' </summary>
Public Class GBM00002SELECT
    Inherits GbPageCommon
    Private Const CONST_MAPID As String = "GBM00002S"       '自身のMAPID
    Private Const CONST_BASEID As String = "GBM00002"
    ...
    Public Sub DefaultValueSet()
        ...
        '選択画面の入力初期値設定
        'メニューから遷移/業務画面戻り判定
        If Page.PreviousPage Is Nothing OrElse TypeOf Page.PreviousPage IsNot GBM00002PORT Then
        ...
        ElseIf TypeOf Page.PreviousPage Is GBM00002PORT Then
            Dim prevPage As GBM00002PORT = DirectCast(Page.PreviousPage, GBM00002PORT)
            '実行画面からの画面遷移
            '○画面項目設定処理
