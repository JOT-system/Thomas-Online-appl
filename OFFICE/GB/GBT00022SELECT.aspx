<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GBT00022SELECT.aspx.vb" Inherits="OFFICE.GBT00022SELECT" %>
...
<%--    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var dblClickObjects = [['<%= Me.txtStApproveDate.ClientID %>', viewCalId],
                                   ['<%= Me.txtEndApproveDate.ClientID %>', viewCalId],
...
<body>
    <%--FormIDは適宜変更ください。 --%>
    <form id="GBT00022S" runat="server">
        <%--ヘッダーボックス --%>
        <div id="divContainer">
            <div id="divTitlebox">
            ...
            <div id="divContensbox">
                ...
                <table id="itemTable">
	                ...
	                <tr>
		                ...
		                <td>
			                <asp:Label ID="lblApproveDate2" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtStApproveDate" runat="server" tabindex="1"></asp:TextBox>
		                </td>
		                <td>
			                <asp:Label ID="lblTilde" runat="server"></asp:Label>
		                </td>
		                <td>
			                <asp:TextBox ID="txtEndApproveDate" runat="server" tabindex="1"></asp:TextBox>
		                </td>
                        <td>
                            &nbsp;
                        </td>
