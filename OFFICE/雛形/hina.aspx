<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="hina.aspx.vb" Inherits="OFFICE.hina" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {
             ...
             */ 
            // var leftListExtentionTarget = [['<%= Me.vLeftBreakerType.ClientID %>', '3', '1']
            //                              ];
            ...
            // setDisplayNameTip(); /* 文言ポップアップ（チップ表示）IDの先頭がlblで始まりTextで終わるもの限定使用する場合はコメントＯＦＦ */
            screenUnlock();
        });
    </script>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divContainer">
            ...
            <div id="divContensbox">
                ...
                <%-- ↓カレンダーのサンプルです消してください↓ --%>
                <div>カレンダーサンプルダブルClickでオープン<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></div>
                <%-- ↑カレンダーのサンプルです消してください↑ --%>
                <%-- ↓左リストのサンプルです消してください↓ --%>
                <div>左リストボックスのサンプル<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox> / <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></div>
                <%-- ↑左リストのサンプルです消してください↑ --%>
                <div id="divHidden">
